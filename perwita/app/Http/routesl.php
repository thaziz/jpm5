...
Route::post('konfirmasi_order/ajax_confirmorderdt' , 'PurchaseController@ajax_confirmorderdt');
...
Route::get('biaya_penerus/update_penerus', 'KasController@update_penerus');
...
Route::get('voucherhutang/voucherhutang', 'PurchaseController@voucherhutang');
Route::get('voucherhutang/createvoucherhutang', 'PurchaseController@createvoucherhutang');
Route::get('voucherhutang/detailvoucherhutang', 'PurchaseController@detailvoucherhutang');
...
// end kelompok akun
//akun
Route::get('master_keuangan/akun', 'master_keuangan\akun_Controller@index');
...
Route::post('master_keuangan/akun/save_data', 'master_keuangan\akun_Controller@save_data');
Route::post('master_keuangan/akun/hapus_data', 'master_keuangan\akun_Controller@hapus_data');
// end kelompok akun
...
// jurnal_umum
Route::get('keuangan/jurnal_umum', 'operasional_keuangan\jurnal_umum_Controller@index');
...
Route::post('keuangan/jurnal_umumform/save_data', 'operasional_keuangan\jurnal_umum_Controller@save_data');
