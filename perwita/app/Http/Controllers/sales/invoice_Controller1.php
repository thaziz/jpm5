...
//           dd($request->all());
        ...
        */
        ...
        for ($i=0; $i < $hitung; $i++) {
            ...
            //     if ($type_kiriman == 'KILOGRAM' or $type_kiriman == 'KOLI' or $type_kiriman == 'KERTAS') {
            //         $tipe = $type_kiriman ;
            ...
            if ($pendapatan == 'PAKET'){
                ...
                if ($type_kiriman == 'KILOGRAM' || $type_kiriman == 'KERTAS') {
                    $kuantum= $data_do->jumlah.' '.$data_do->kode_satuan;
            ...
            /*$id_akun[$i]['akunPendapatan']=$data_do->acc_penjualan;
            $id_akun[$i]['subtotal']=$data_do->total;*/
...
foreach ($Nilaijurnal as  $dataJurnal) {    
       ...
       $akunPendapatan=master_akun::
        ...
        $akun[$indexakun]['value']=$dataJurnal['subtotal']+$dataJurnal['diskon'];
        $akun[$indexakun]['dk']='K';
        $indexakun++;      
...
//exclude
    ...
    public function hapus_data_detail (Request $request) {
        ...
        if ($cek_data !=NULL) {
            ...
            $pph =  round($netto * $nilai_pajak->nilai/100,2);
            $data_h = array(
                'total' => $invoice_d->ttl_harga_netto,
                'diskon' => $diskon,
                'netto' => $netto,
...
//exclude
    ...
    public function form($nomor=null){
        ...
        $customer = DB::select(" SELECT kode,nama,syarat_kredit,acc_piutang FROM customer ORDER BY nama ASC ");
