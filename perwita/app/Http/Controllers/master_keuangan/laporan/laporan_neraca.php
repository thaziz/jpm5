...
class laporan_neraca extends Controller
{
  ...
  public function print_pdf_neraca_single(Request $request, $throttle){
    ...
    $pdf = PDF::loadView('laporan_neraca.print_pdf.pdf_single', compact('data_neraca', 'data_detail', 'request', 'throttle'))
                  ->setPaper('A4','potrait');
  ...
  public function print_pdf_neraca_perbandingan(Request $request, $throttle){
    ...
    $pdf = PDF::loadView('laporan_neraca.print_pdf.pdf_perbandingan', compact('data_neraca_1', 'data_neraca_2', 'data_detail_1', 'data_detail_2', 'request', 'throttle'))->setPaper('A4','potrait');
