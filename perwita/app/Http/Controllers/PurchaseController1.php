...
<<<<<<< HEAD
			...
			foreach ($request->biaya as $idx => $value) {
			   ...
			   if($request->jenisppn=='E'){   
               $id_akun[$idx]['subtotal']=$subtotal;
               $id_akun[$idx]['ppn']=$subtotal*$request->inputppn/100;
               $id_akun[$idx]['pph']=$subtotal*$request->inputpph/100;
        	   }       
        	   else if($request->jenisppn=='I'){             	   
        	   $includeSubTotal=$subtotal*100/(100+$request->inputppn);        	           	   	
               $id_akun[$idx]['subtotal']=$includeSubTotal;
               $id_akun[$idx]['ppn']=$subtotal*$request->inputppn/(100+$request->inputppn);
               $id_akun[$idx]['pph']=$includeSubTotal*$request->inputpph/100;
        	   }   	   
        	}
...
>>>>>>> 13dd30d1e10aba4e18b4dfc1d65bcbefe03af54a
	}
