...
Route::get('jurnalselaras/notabankmasuk2', 'jurnal_pembelian@notabankmasuktransaksibm');
...
Route::get('pengeluaranbarang/pengeluaranbarang/cari', 'PengeluaranBarangController@cari');
