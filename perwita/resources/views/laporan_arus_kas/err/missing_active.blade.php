                      ...
                      <div class="box" id="seragam_box">
                        ...
                        <div class="box-body" style="min-height: 330px;">
                          <div class="col-md-12" style="border-bottom: 1px solid #eee; padding-bottom: 10px;">
                            <center><small class="text-muted">Tidak Ada Desain Arus Kas Yang Aktif. Sehingga Laporan Arus Kas Tidak Bisa Ditampilkan. <b>Silahkan Aktifkan Salah Satu Desain Dibawah Ini.</b></small></center>
                          </div>
      ...
      $.ajax(baseUrl+"/master_keuangan/desain_arus_kas/aktifkan/"+$(this).data("id"), {
         ...
         success: function (data) {
            if(data.status == "sukses"){
              alert("Desain Arus Kas Berhasil Digunakan. Halaman Akan Dimuat Ulang");
              location.reload();
