...
<fieldset class="scheduler-border">
    ...
    <table>
      ...
      <tr>
        <td>DANA KAS OPS (PERIODE 31 MEI 2017 ) NGANJUK MADIUN</td>
      </tr>
    </table>
</fieldset>
</div>
   ...
   <table class="size textcenter table-responsive" width="100%">
     <tr>  
          <th colspan="3" class="top right textcenter" width="35%" height="25px">No.Pengajuan Cek/BG (AJU)</th>
     ...
     <tr height="25px">
          <th class="top right bot textcenter">Nomor</th>
          <th class="top right bot textcenter">Tanggal</th>
          <th class="top right bot textcenter">Jml.Pelunasan</th>
     </tr>
     <tr>
       <td class="right textleft" valign="top" height="300">
         <table>
          <tr>
           <td>REM-292/AP/0192</td>
          </tr>
          <tr>
           <td>REM-292/AP/0192</td>
          </tr>
       ...
       <td class="textright right" valign="top" height="300">
         <table width="100%">
          <tr>
           <td>2.670.000,00</td>
          </tr>
        ...
        <td class="textcenter top right" valign="top" height="300">
         <table width="100%">
          <tr>
           <td>NGANJUK RB-1112/12/1111 MINGGU KE 4</td>
          </tr>
          <tr>
           <td>NGANJUK RB-1112/12/1111 MINGGU KE 4</td>
          </tr>
         ...
         <table width="100%">
          <tr>
           <td>BCA BAYANGKARA 6100.1999</td>
          </tr>
         </table>
       </td>
     ...
     <tr height="25px">
       <td colspan="2" class="top right">Total Pengajuan</td>
       <td class="textright top right">7.336.000,00</td>
       <td colspan="3" class="textright top right">Total Cek/BG</td>
       <td class="textright top right">7.336.000,00</td>
     </tr>
     <tr height="25px">
       <td colspan="7" class="textleft top">Terbilang : Tujuh juta ewu ewu eket</td>
     </tr>
   </table>
   <table class="textcenter" width="100%">
     <tr>
       <td class="top right">Dibuat Oleh :</td>
       <td class="top right">Penerima</td>
       <td class="top right">Disetujui Oleh :</td>
       <td class="top">Mengetahui :</td>
     </tr>
     <tr>
