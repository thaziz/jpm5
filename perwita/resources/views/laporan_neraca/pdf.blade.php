...
@if($throttle == "perbandingan_bulan")
	<table width="100%" border="0" style="font-size: 10pt; border-bottom: 1px solid #333;">
		<thead>
			<tr>
				<th style="text-align: left;">Laporan Perbandingan Neraca Keuangan Dalam Bulan</th>
	...
	<table id="content" width="100%" border="0" style="font-size: 9pt; margin-top: 5px;">
		<thead>
			<tr>
				<td width="50%" style="text-align: center; border: 1px solid #333;padding: 10px; font-size: 10pt;">Aktiva {{ $request["m"]}}</td>
				<td style="text-align: center; border: 1px solid #333;padding: 10px; font-size: 10pt;">Aktiva {{ $request["y"]}}</td>
			</tr>
	  ...
	  <tr>
	  	<td width="50%">
	  		<table width="100%" style="font-size: 10pt;">
	  			<tr>
	  				<td style="border-bottom: 1px solid #333;padding: 5px 3px; font-weight: bold;text-align: center;">Total Akhir Aktiva</td>
	...
	<table id="content" width="100%" border="0" style="font-size: 9pt; margin-top: 5px;">
		<thead>
			<tr>
				<td width="50%" style="text-align: center; border: 1px solid #333;padding: 10px; font-size: 10pt;">Pasiva {{ $request["m"]}}</td>
				<td style="text-align: center; border: 1px solid #333;padding: 10px; font-size: 10pt;">Pasiva {{ $request["y"]}}</td>
			</tr>

			<tr>
				<td style="text-align: center;border: 1px solid #333; vertical-align: top;">
					<table width="100%" id="bingkai" style="font-size: 8pt;">
		                  <?php $dataTotalPasiva1 = 0; $tot = 0;?>
		                  @foreach($datat1 as $dataAktiva)
		                    <?php 
		                      $header = ""; $child = ""; $total = ""; 
	...
	<table id="tree" width="100%" style="margin-top: 20px;">
	  <tr>
	  	<td width="50%">
	  		<table width="100%" style="font-size: 10pt;">
	  			<tr>
	  				<td style="border-bottom: 1px solid #333;padding: 5px 3px; font-weight: bold;text-align: center;">Total Akhir Pasiva</td>
	  				<td style="text-align: right;border: 1px solid #333;padding: 5px 3px;font-weight: bold;">{{ ($dataTotalPasiva1 < 0) ? str_replace("-", "", "(".number_format($dataTotalPasiva1).")") : number_format($dataTotalPasiva1) }}</td>
	  			</tr>
	  		</table>
	  	</td>
	  	...
	  	<td>
	  		<table width="100%" style="font-size: 10pt;">
	  			<tr>
	  				<td style="border-bottom: 1px solid #333;padding: 5px 3px; font-weight: bold;text-align: center;">Total Akhir Pasiva</td>
	  				<td style="text-align: right;border: 1px solid #333;padding: 5px 3px;font-weight: bold;">{{ ($dataTotalPasiva2 < 0) ? str_replace("-", "", "(".number_format($dataTotalPasiva2).")") : number_format($dataTotalPasiva2) }}</td>
	  			</tr>
	  		</table>
	  	</td>
	  </tr>     
...
@elseif($throttle == "perbandingan_tahun")
	<table width="100%" border="0" style="font-size: 10pt; border-bottom: 1px solid #333;">
		<thead>
			<tr>
				<th style="text-align: left;">Laporan Perbandingan Neraca Keuangan Dalam Tahun</th>
				<th style="text-align: right;">PT. Jawa Pratama Mandiri</th>
			</tr>
		</thead>
	</table>
...
@else
	<table width="100%" border="0" style="font-size: 10pt; border-bottom: 1px solid #333;">
		<thead>
			<tr>
				<th style="text-align: left;">Laporan Neraca Keuangan {{ ($throttle == "bulan") ? "Bulanan" : "Tahunan" }}</th>
				<th style="text-align: right;">PT. Jawa Pratama Mandiri</th>
			</tr>
		</thead>
	</table>
	...
	<table id="content" width="100%" border="0" style="font-size: 9pt; margin-top: 5px;">
		<thead>
			<tr>
				<td width="50%" style="text-align: center; border: 1px solid #333;padding: 10px; font-size: 10pt;">Aktiva</td>
				<td style="text-align: center; border: 1px solid #333;padding: 10px; font-size: 10pt;">Pasiva</td>
			</tr>
	  ...
	  <tr>
	  	...
	  	<td>
	  		<table width="100%" style="font-size: 10pt;">
	  			<tr>
	  				<td style="border-bottom: 1px solid #333;padding: 5px 3px; font-weight: bold;text-align: center;">Total Akhir Pasiva</td>
	  				<td style="text-align: right;border: 1px solid #333;padding: 5px 3px;font-weight: bold;">{{ ($DatatotalPasiva < 0) ? str_replace("-", "", "(".number_format($DatatotalPasiva).")") : number_format($DatatotalPasiva) }}</td>
	  			</tr>
	  		</table>
	  	</td>
	  </tr>     
