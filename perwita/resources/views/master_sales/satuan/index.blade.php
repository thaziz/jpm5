                ...
                <div class="ibox-title">
                    <h5> SATUAN
                     <!-- {{Session::get('comp_year')}} -->
                      ...
                      @if(Auth::user()->punyaAkses('Satuan','tambah'))
                        ...
                        <form class="form-horizontal  kirim">
                          <table id="table_data" class="table table-striped table-bordered table-hover">
                            <tbody>
                                ...
                                <tr>
                                    <td style="padding-top: 0.4cm">Isi</td>
                                    <td><input type="number" class="form-control" name="ed_isi" style="text-transform: uppercase" ></td>
                                </tr>
                            </tbody>
                          </table>
                        </form>
...
<script type="text/javascript">
    $(document).ready( function () {
        $('#table_data').DataTable({
            ...
            "retrieve" : true,
            "ajax": {
              "url" :  baseUrl + "/master_sales/satuan/tabel",
              "type": "GET"
            },
            "columns": [
            { "data": "kode" },
    ...
    $(document).on( "click",".btnedit", function() {
        ...
        $.ajax(
        {
            url : baseUrl + "/master_sales/satuan/get_data",
            type: "GET",
            data : value,
            dataType:'json',
            success: function(data, textStatus, jqXHR)
            {
                ...
                $("input[name='ed_isi']").val(data.isi);
                $("#modal").modal('show');
                $("input[name='ed_kode']").focus();
            },
    ...
    $(document).on("click","#btnsave",function(){
        ...
        */
        $.ajax(
        {
            url : baseUrl + "/master_sales/satuan/save_data",
            type: "POST",
            dataType:"JSON",
    ...
    $(document).on( "click",".btndelete", function() {
        ...
        $.ajax({
            type: "POST",
            url : baseUrl + "/master_sales/satuan/hapus_data",
            dataType:"JSON",
            data: value,
            success: function(data, textStatus, jqXHR)
            {
