                       ...
                       <!--  <div class="form-group">
                          ...
                          <form action="" class="form-horizontal" method="post" >
                              <table class="table table-striped table-bordered dt-responsive nowrap table-hover">
                                  <tbody>
                                      <tr>
                                          <td style="width:110px; padding-top: 0.4cm">Kode Relasi</td>
                                          <td>
                                      ...
                                      <tr>
                                          <td style="padding-top: 0.4cm">Relasi</td>
                                          <td>
                              ...
                              <div class="row">
                                <div class="col-md-4">
                                  <button type="button" class="btn btn-primary " id="btnadd" name="btnadd"><i class="fa fa-plus"></i> Add Saldo Awal Piutan Lain Detail</button>
                                </div>
                        ...
                        <div class="modal-dialog modal-lg">
                          <div class="modal-content">
                            <div class="modal-header">
                              ...
                              <h4 class="modal-title">Insert Edit Saldo Awal Piutan Lain Detail</h4>
                            </div>
                            <div class="modal-body">
                              <form class="form-horizontal">
                                <table id="table_data" class="table table-striped table-bordered table-hover">
                                  <tbody>
                                      <tr>
                                          <td style="padding-top: 0.4cm; width:150px;">Nomor Piutang Lain</td>
                                          <td><input type="text" class="form-control" id="edsatuan"></td>
                                      </tr>
                                      <tr>
                                          <td style="padding-top: 0.4cm">Tanggal Piutang</td>
                                          <td>
                                                <div class="input-group date">
                                                    <span class="input-group-addon"><i class="fa fa-calendar"></i></span><input type="text" class="form-control" value="<?php echo date('Y-m-d',time())?>">
                                                </div>
                                      ...
                                      <tr>
                                          ...
                                          <td><input type="text" class="form-control" id="edtotal" style="text-align:right" ></td>
                                      </tr>
