        ...
        <div class="col-lg-12" >
            <div class="ibox float-e-margins">
                <div class="ibox-title">
                    @if($throttle == "bulan")
                      <h5> Menampilkan Laba Rugi Periode Bulan {{ $request["m"]."/".$request["y"] }}</h5>
                    @elseif($throttle == "tahun")
                      <h5> Menampilkan Laba Rugi Periode Tahun {{ $request["y"] }}</h5>
                    @elseif($throttle == "perbandingan_bulan")
                      <h5> Menampilkan Perbandingan Laba Rugi Bulan {{ $request["m"] }} Dan Bulan {{ $request["y"] }}</h5>
                    @elseif($throttle == "perbandingan_tahun")
                      <h5> Menampilkan Perbandingan Laba Rugi Tahun {{ $request["m"] }} Dan Tahun {{ $request["y"] }}</h5>
                    @endif

                    <div class="ibox-tools">
                        <a href="{{ route("laba_rugi.pdf", $throttle."?m=".$request["m"]."&y=".$request["y"]) }}" target="_blank">
                          <button class="btn btn-sm btn-primary">
                            <i class="fa fa-file-pdf-o"></i> &nbsp;Cetak PDF
                          </button>
                        </a>

                        <a href="{{ route("laba_rugi.excel", $throttle."?m=".$request["m"]."&y=".$request["y"]) }}" target="_blank">
                          <button class="btn btn-sm btn-primary">
                              ...
                              <div class="row-eq-height">
                                <div class="col-md-6">                           
                                  <table id="tree" width="100%">
                                      <thead>
                                        <tr>
                                          <th colspan="2" class="text-center">Laba Rugi {{ $request["m"] }}</th>
                                        </tr>
                                ...
                                <div class="col-md-6">                           
                                  <table id="tree" width="100%">
                                      <thead>
                                        <tr>
                                          <th colspan="2" class="text-center">Laba Rugi {{ $request["y"] }}</th>
                                        </tr>
  ...
  $(document).ready(function(){
    ...
    $("#filter").click(function(evt){
      ...
      if($("#show").val() == "perbandingan_bulan"){
        ...
        window.location = baseUrl+"/master_keuangan/laba_rugi/"+$("#show").val()+"?m="+$("#bulan1").val()+"&y="+$("#bulan2").val();
        ...
        window.location = baseUrl+"/master_keuangan/laba_rugi/"+$("#show").val()+"?m="+$("#tahun1").val()+"&y="+$("#tahun2").val();
      }else{
        ...
        window.location = baseUrl+"/master_keuangan/laba_rugi/"+$("#show").val()+"?m="+$("#dateMonth").val()+"&y="+$("#dateYear").val();
      }
