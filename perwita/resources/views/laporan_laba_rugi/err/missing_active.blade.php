                      ...
                      <div class="box" id="seragam_box">
                        ...
                        <div class="box-body" style="min-height: 330px;">
                          <div class="col-md-12" style="border-bottom: 1px solid #eee; padding-bottom: 10px;">
                            <center><small class="text-muted">Tidak Ada Desain Laba Rugi Yang Aktif. Sehingga Laporan Laba Rugi Tidak Bisa Ditampilkan. <b>Silahkan Aktifkan Salah Satu Desain Dibawah Ini.</b></small></center>
                          </div>
      ...
      $.ajax(baseUrl+"/master_keuangan/desain_laba_rugi/aktifkan/"+$(this).data("id"), {
         ...
         success: function (data) {
            if(data.status == "sukses"){
              alert("Desain Laba Rugi Berhasil Digunakan. Halaman Akan Dimuat Ulang");
              location.reload();
