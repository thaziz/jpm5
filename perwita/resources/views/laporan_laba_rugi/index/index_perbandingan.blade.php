            ...
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                  <div class="row">
                    ...
                    <div class="col-md-6">
                      <div class="col-md-12 text-center text-muted" style="padding: 10px; border: 1px solid #eee; box-shadow: 0px 0px 10px #eee;">Laba Rugi {{ $request->m }}</div>
                    ...
                    <div class="col-md-6">
                      <div class="col-md-12 text-center text-muted" style="padding: 10px; border: 1px solid #eee; box-shadow: 0px 0px 10px #eee;">Laba Rugi {{ $request->y }}</div>
                    ...
                    <div class="col-md-6 m-t">
                      <div class="col-md-12" style="border: 1px solid #eee; box-shadow: 0px 0px 0px #eee; padding: 0px;">
                        <table class="table_neraca" width="100%" style="font-size: 8pt;" border="0">
                          ...
                          <tr>
                            <td class="text-center">Total Laba Rugi {{ $request->m }}</td>
                            <td class="money">{{ $num }}</td>
                          </tr>
                    ...
                    <div class="col-md-6 m-t">
                      <div class="col-md-12" style="border: 1px solid #eee; box-shadow: 0px 0px 0px #eee; padding: 0px;">
                        <table class="table_neraca" width="100%" style="font-size: 8pt;" border="0">
                          ...
                          <tr>
                            <td class="text-center">Total Laba Rugi {{ $request->y }}</td>
                            <td class="money">{{ $num }}</td>
                          </tr>
...
<script type="text/javascript">
  ...
  $(document).ready(function(){
   ...
   switch(throttle){
    case "p_bulan" :
      $("#tampil").val(throttle);
      $("#title_in").text("Menampilkan Laba Rugi Perbandingan Periode Bulan "+req1+" Dan "+req2);
      $("#bulan_1").css("display", "inline-block"); $("#bulan_2").css("display", "inline-block");
      $("#bulan_1").val(req1); $("#bulan_2").val(req2);
      break;
    case "p_tahun" :
      $("#tampil").val(throttle);
      $("#title_in").text("Menampilkan Laba Rugi Perbandingan Periode Tahun "+req1+" Dan "+req2);
