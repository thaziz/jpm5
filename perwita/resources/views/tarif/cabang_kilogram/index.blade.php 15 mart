                          ...
                          <table class="table table-striped table-bordered table-hover ">
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>   
                                        <select class="form-control e"  name="cb_keterangan" style="width:100%">
                                            <option value="" selected="" disabled="">-- Pilih Kota Keterangan --</option>
                                            ...
                                            <option value="TARIF DI ATAS 20 KG">TARIF DI ATAS 20 KG</option>
