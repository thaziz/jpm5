                        ...
                        <form class="form-horizontal kirim">
                          <table class="table table-striped table-bordered table-hover ">
                            <tbody>
                                ...
                                <tr>
                                  <td style="padding-top: 0.4cm">Tarif Dokumen</td>
                                    <td><input type="text" class="form-control" name="tarif_dokumen"></td>
                                </tr>
                           ...
                           <table class="table-striped table-bordered" width="48%"> 
                              ...
                              <tbody>
                                  ...
                                  <tr>
                                      ...
                                      <td class="pad"><input type="text" name="tarifsel_reguler"></td>
                                  </tr>
                                  <tr>
                          ...
                          <table class="table-striped table-bordered" style="margin-left: 45%;margin-top: -260px;position: fixed;" width="48%"> 
                              <thead>
                                  <tr>
                              ...
                              <tbody>
                                  ...
                                  <tr>
                                      <td class="pad">Tarif Kg selanjutnya</td>
                                      <td class="pad"><input type="text" name="tarifsel_express"></td>
                                  </tr>
                                  <tr>
                                      <td class="pad">Berat Minimum</td>
