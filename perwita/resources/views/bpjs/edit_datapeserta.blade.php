                  ...
                  <form class="form-horizontal">
                    <div class="form-group">
                      <label class="control-label col-sm-2" for="nokartu">Nomer Kartu</label>
                        <div class="col-sm-8">
                          <input type="text" class="form-control" id="nokartu" placeholder="value nokartu tenaga kerja">
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                      <label class="control-label col-sm-2" for="npp">NPP</label>
                        <div class="col-sm-8">
                          <input type="text" class="form-control" id="npp" placeholder="value npp tenaga kerja">
                        </div>
                    </div>
                    <div class="form-group">
                     ...
                     <div class="form-group">
                      <label class="control-label col-sm-2" for="keluarga">Hub.Keluarga</label>
                        <div class="col-sm-8">
                          <input type="text" class="form-control" id="keluarga" placeholder="value keluarga tenaga kerja">
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                      <label class="control-label col-sm-2" for="tmt">TMT</label>
                        <div class="col-sm-8">
                          <input type="text" class="form-control" id="tmt" placeholder="value tmt tenaga kerja">
                        </div>
                    </div>
                    <div class="form-group">
                      <label class="control-label col-sm-2" for="faskes">Nama Faskes Tingkat 1</label>
                        <div class="col-sm-8">
                          <input type="text" class="form-control" id="faskes" placeholder="value faskes tenaga kerja">
                        </div>
                    </div> 
                     <div class="form-group">
                      <label class="control-label col-sm-2" for="faskesgigi">Nama Faskes Gigi</label>
                        <div class="col-sm-8">
                          <input type="text" class="form-control" id="faskesgigi" placeholder="value faskesgigi tenaga kerja">
                        </div>
                    </div>
                    <div class="form-group">
                      <label class="control-label col-sm-2" for="instasi">Nama Sub Instansi</label>
                        <div class="col-sm-8">
                          <input type="text" class="form-control" id="instasi" placeholder="value instasi tenaga kerja">
                        </div>
                    </div>
                    <div class="form-group"> 
