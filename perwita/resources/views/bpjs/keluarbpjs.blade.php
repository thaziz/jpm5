            ...
            <div class="col-xs-12">
              ...
              <div class="box" id="#">
                <div class="row">
                    ...
                    <div class="col-md-2"> <a type="button" class="btn btn-box-tool" style="color: #888; font-size:12pt;" title="tambahkan data item" href="{{url('bpjs/input_keluarbpjs')}}"><i class="fa fa-plus" aria-hidden="true"></i> &nbsp;Tambah Data</a>
                      ...
                      <tr>
                        ...
                        <td class="text-center">
                          ...
                          <ul class="dropdown-menu" aria-labelledby="dropdownMenu1">
                            <li><a href="{{url('bpjs/edit_keluarbpjs')}}"><i class="fa fa-pencil" aria-hidden="true"></i> Ubah Item</a></li>
                ...
                <div class="box-footer">
                  <div class="pull-right">
                      <input type="submit" id="submit" name="submit" value="Print" class="btn btn-info" onclick="window.open('cetak_keluarbpjs')">
                    </div>
                  </div><!-- /.box-footer --> 
              </div><!-- /.box -->
            </div><!-- /.col -->
