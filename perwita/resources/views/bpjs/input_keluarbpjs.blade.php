                  ...
                  <form class="form-horizontal">
                    ...
                    <div class="form-group">
                      <label class="control-label col-sm-2" for="no peserta">Nomor Peserta</label>
                        <div class="col-sm-8">
                          <input type="text" class="form-control" id="no peserta" placeholder="no peserta tenaga kerja">
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                      <label class="control-label col-sm-2" for="upah">Upah Sebulan</label>
                        <div class="col-sm-8">
                          <input type="text" class="form-control" id="upah" placeholder="upah tenaga kerja">
                        </div>
                    </div> 
                    <div class="form-group">
                    ...
                    <div class="form-group"> 
                      <div class="col-sm-offset-2 col-sm-10">
                        ...
                        <a href="{{ url('bpjs/keluarbpjs ') }}"<button type="button" class="btn btn-md btn-danger" title="kembali">Kembali</button></a>
                      </div>
                    </div>
                  </form>
                </div><!-- /.box-body -->
