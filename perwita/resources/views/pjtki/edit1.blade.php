                  ...
                  <form class="form-horizontal">
                    <div class="form-group">
                      <label class="control-label col-sm-2" for="nama">Nama Mitra</label>
                        <div class="col-sm-8">
                          <input type="text" class="form-control" id="nama" placeholder="value nama mitra">
                        </div>
                    </div>
                    <div class="form-group">
                      <label class="control-label col-sm-2" for="alamat">Alamat Mitra</label>
                        <div class="col-sm-8">
                          <input type="text" class="form-control" id="alamat" placeholder="value alamat mitra">
                        </div>
                    </div>
                     <div class="form-group">
                      <label class="control-label col-sm-2" for="tlp">No.Tlp</label>
                        <div class="col-sm-8">
                          <input type="text" class="form-control" id="tlp" placeholder="value tlp mitra">
                        </div>
                    </div>
                    <div class="form-group">
                      <label class="control-label col-sm-2" for="divisi">Divisi</label>
                        <div class="col-sm-8">
                          <input type="text" class="form-control" id="divisi" placeholder="value divisi mitra">
                        </div>
                    </div>
                    <div class="form-group">
                      <label class="control-label col-sm-2" for="pengawas">Pengawas Lapangan</label>
                        <div class="col-sm-8">
                          <input type="text" class="form-control" id="pengawas" placeholder="value pengawas mitra">
                        </div>
                    </div>
                    <div class="form-group">
                      <label class="control-label col-sm-2" for="program">Program Berkerja</label>
                        <div class="col-sm-8">
                          <input type="text" class="form-control" id="program" placeholder="value program mitra">
                        </div>
                    </div>
                    <div class="form-group"> 
