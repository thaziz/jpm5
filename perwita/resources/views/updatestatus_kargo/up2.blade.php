              ...
              <div class="box" id="seragam_box">
                <div class="box-header">
                    ...
                    <div class="col-sm-offset-5 ">
                            ...
                            <a href="{{url('updatestatus_kargo')}}" class="btn btn-danger fa fa-minus">&nbsp; Cancel</a>
                        </div>
                    </div>
                    </div>
                  </div>
...
$(document).ready(function() {
     ...
     var b =$(this).val();
        console.log(b);
          $.ajax({
                url: baseUrl + '/updatestatus_kargo/data2/'+b,
                type: 'get',
                timeout: 10000,
                dataType: 'json',
...
function gege(){
  ...
  $.ajax({
        url: baseUrl+'/updatestatus_kargo/store2',
        type:'get',
        data:data,
         success:function(response){
 ...
 $('#nomor').change(function() {
  ...
  $("#nomor").autocomplete({
        source: baseUrl+'/updatestatus_kargo/up2/autocomplete',
        minLength: 1,
