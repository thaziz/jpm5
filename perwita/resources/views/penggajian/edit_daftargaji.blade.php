                  ...
                  <form class="form-horizontal">
                    ...
                    <div class="form-group">
                      <label class="control-label col-sm-2" for="jabatan">Jabatan</label>
                        <div class="col-sm-8">
                          <input type="text" class="form-control" id="jabatan" placeholder="value jabatan tenaga kerja">
                        </div>
                    </div>
                    <div class="form-group">
                      <label class="control-label col-sm-2" for="gapok">Gaji Pokok</label>
                        <div class="col-sm-8">
                          <input type="text" class="form-control" id="gapok" placeholder="value gapok tenaga kerja">
                        </div>
                    </div>
                    <div class="form-group">
                      <label class="control-label col-sm-2" for="masaker">T. MASA KERJA</label>
                        <div class="col-sm-8">
                          <input type="text" class="form-control" id="masaker" placeholder="value masaker tenaga kerja">
                        </div>
                    </div>
                    <div class="form-group">
                      <label class="control-label col-sm-2" for="masajab">T. JABATAN</label>
                        <div class="col-sm-8">
                          <input type="text" class="form-control" id="masajab" placeholder="value masajab tenaga kerja">
                        </div>
                    </div>
                    <div class="form-group">
                      <label class="control-label col-sm-2" for="funsi">T. FUNGSIONAL</label>
                        <div class="col-sm-8">
                          <input type="text" class="form-control" id="funsi" placeholder="value funsi tenaga kerja">
                        </div>
                    </div>
                    <div class="form-group">
                      <label class="control-label col-sm-2" for="bpjs">BPJS TK</label>
                        <div class="col-sm-8">
                          <input type="text" class="form-control" id="bpjs" placeholder="value bpjs tenaga kerja">
                        </div>
                    </div>
                    <div class="form-group">
                      <label class="control-label col-sm-2" for="potongan">POTONGAN</label>
                        <div class="col-sm-8">
                          <input type="text" class="form-control" id="potongan" placeholder="value potongan tenaga kerja">
                        </div>
                    </div> 
                    <div class="form-group"> 
