                ...
                <div class="box-body">
                  <form class="form-horizontal">
                    <div class="form-group">
                      <label class="control-label col-sm-2" for="nik">NO</label>
                        <div class="col-sm-8">
                          <input type="text" class="form-control" id="nik" placeholder="No">
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                      <label class="control-label col-sm-2" for="jabatan">Upah Seragam</label>
                        <div class="col-sm-8">
                          <input type="text" class="form-control" id="jabatan" placeholder="Upah Tenaga Kerja">
                        </div>
                    </div>
