                    ...
                    <table class="table table-striped table-bordered table-hover">
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <input type="text" name="ed_terpakai" class="form-control angka" style="text-transform: uppercase ; text-align: right" readonly="readonly" tabindex="-1" @if ($data === null) value="0" @else value="{{ number_format($data->terpakai, 0, ",", ".") }}" @endif>
                                </td>
                            </tr>
