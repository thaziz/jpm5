                    ...
                    <table class="table table-hover">
                        <tbody>
                            <tr>
                                ...
                                <td colspan="4">
                                    <input type="text" name="ed_total" class="form-control" readonly="readonly" style="text-transform: uppercase;text-align:right" @if ($data === null) value="0" @else value="{{ number_format($data->total, 0, ",", ".") }}" @endif>
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td colspan="4">
                                    <input type="text" name="ed_netto" id="ed_netto" class="form-control" readonly="readonly" style="text-transform: uppercase;text-align:right" @if ($data === null) value="0" @else value="{{ number_format($data->netto, 0, ",", ".") }}" @endif>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    <input type="text" name="ed_ppn" class="form-control" readonly="readonly" style="text-transform: uppercase;text-align:right" @if ($data === null) value="0" @else value="{{ number_format($data->ppn, 0, ",", ".") }}" @endif>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    <input type="text" name="ed_pph" class="form-control" readonly="readonly" style="text-transform: uppercase;text-align:right" @if ($data === null) value="0" @else value="{{ number_format($data->pph, 0, ",", ".") }}" @endif>
                                </td>
                            </tr>
                            <tr>
                                <td style="padding-top: 0.4cm; text-align:right">Total Tagihan</td>
                                <td colspan="4">
                                    <input type="text" name="ed_total_tagihan" class="form-control" readonly="readonly" style="text-transform: uppercase;text-align:right" @if ($data === null) value="0" @else value="{{ number_format($data->total_tagihan, 0, ",", ".") }}" @endif>
                                </td>
                            </tr>
                        </tbody>
                    </table>
