                    ...
                    <table class="table table-striped table-bordered table-hover">
                        <tbody>
                            <tr>
                                ...
                                <td colspan="4">
                                    <input type="text" name="ed_nomor" id="ed_nomor" readonly="" class="form-control" style="text-transform: uppercase" value="{{ $data->nomor or null }}" >
...
<script type="text/javascript">
    ...
    function hapus(id) {
        $.ajax({
            ...
            type:'get',
            success:function(response){
                var table3 = $('#table_data').DataTable();
                table3.ajax.reload();
                var temp = 0;
                table3.$('.btndelete').each(function(){
                    temp+=1;
                })
                console.log(temp);
                if (temp-1 <= 0) {
                    $('.tr_cabang').removeClass('disabled');
                    $('.tr_rute').removeClass('disabled');
                    $('.tr_nopol').removeClass('disabled');
                }
            },
            error:function(){
                toastr.warning('Terjadi Kesalahan');
