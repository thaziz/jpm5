...
<body>
  <div class="wrapper">
    ...
    <div style="position: relative;">
      ...
      <table>
        <tr>
          <td>Phone / Fax : {{$telpon_pengirim}}</td>
        </tr>
        <tr>
        ...
        <tr>
          <td>Phone / Fax : {{$telpon_penerima}}</td>
        </tr>
      ...
      <div class="pull-right" style="margin-top: -26%; padding-right:100px; padding-top:40px ">
        <table>
          ...
          <tr>
            <td >
            @if ($type_kiriman == 'SEPEDA')
            Jumlah : {{ number_format($koli,0,',','.') }} 
            @else
            Colly :{{ number_format($koli,0,',','.') }}  
            @endif</td>
            <td >Kg: {{ number_format($kg,0,',','.') }}</td>
          </tr>
          <tr>
