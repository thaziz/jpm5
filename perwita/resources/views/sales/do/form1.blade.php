                ...
                <div class="box-header">
                  ...
                  <div class="box-body">
                       <!--  <div class="form-group">
                        ...
                        <div class="x_content">
                            <form method="post" id="form_header" class="form-horizontal kirim">
                                <table class="table table-striped table-bordered dt-responsive nowrap table-hover">
                                    <tbody>
                                        <tr style="max-height: 15px !important; height: 15px !important; overflow:hidden;">
                                            ...
                                            <td>
                                                <input type="text" class="form-control" id="ed_nomor" name="ed_nomor" style="text-transform: uppercase" @if ($do !== null) value="{{$do->nomor}}" @endif >
                                                <input type="hidden" class="form-control" id="ed_nomor_old" name="ed_nomor_old">
                                                <input type="hidden" class="form-control" name="_token" value="{{ csrf_token() }}" readonly >
                                                <input type="hidden" class="form-control" name="crud_h" value="N">
                                            </td>
                                            <td style="padding-top: 0.4cm">Tanggal</td>
                                            <td>
                                                <div class="input-group date">
                                                    <span class="input-group-addon"><i class="fa fa-calendar"></i></span><input type="text" class="form-control" name="ed_tanggal" @if ($do !== null) value="{{$do->tanggal}}" @else value="<?php echo date('Y-m-d',time())?>" @endif >
                                                </div>
                                            </td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <input type="text" class="form-control" name="ed_biaya_tambahan" style="text-align:right" @if ($do !== null) value="{{$do->biaya_tambahan}}" @else value="0" @endif >
                                            </td>
                                            <td style="padding-top: 0.4cm" id="div_kom">Biaya Komisi</td>
                                            <td colspan="" id="div_kom">
                                                <input type="text" class="form-control" name="ed_biaya_komisi" id="biaya_komisi" style="text-align:right" @if ($do !== null) value="{{$do->biaya_komisi}}" @else value="0" @endif >
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td colspan="2">
                                                <div class="checkbox">
                                                    <label>
                                                        <input type="checkbox" name="ck_ppn" @if ($do !== null) value="{{$do->ppn}}" @endif > PPN
                                                    </label>
                                                </div>
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td>
                                                <input type="text" class="form-control" name="ed_nama_pengirim" style="text-transform: uppercase" @if ($do !== null) value="{{$do->nama_pengirim}}" @endif >
                                            </td>
                                            <td style="width:110px;">Alamat Pengirim</td>
                                            <td>
                                                <input type="text" class="form-control" name="ed_alamat_pengirim"  style="text-transform: uppercase" @if ($do !== null) value="{{$do->alamat_pengirim}}" @endif >
                                            </td>
                                            <td style="width:110px;">Telpon Pengirim</td>
                                            <td>
                                                <input type="text" class="form-control" name="ed_telpon_pengrim"  style="text-transform: uppercase" @if ($do !== null) value="{{$do->telpon_pengirim}}" @endif >
                                            </td>
                                        </tr>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <input type="text" class="form-control" name="ed_nama_penerima"  style="text-transform: uppercase" @if ($do !== null) value="{{$do->nama_penerima}}" @endif >
                                            </td>
                                            <td style="width:110px;">Alamat Penerima</td>
                                            <td>
                                                <input type="text" class="form-control" name="ed_alamat_penerima"  style="text-transform: uppercase" @if ($do !== null) value="{{$do->alamat_penerima}}" @endif >
                                            </td>
                                            <td style="width:110px;">Telpon Penerima</td>
                                            <td>
                                                <input type="text" class="form-control" name="ed_telpon_penerima"  style="text-transform: uppercase" @if ($do !== null) value="{{$do->telpon_penerima}}" @endif >
                                            </td>
                                        </tr>
                                        <tr>
                                            <td style="padding-top: 0.4cm">Total</td>
                                            <td >
                                                <input type="text" class="form-control" name="ed_total" style="text-align:right" readonly="readonly" tabindex="-1" @if ($do !== null) value="{{$do->total}}" @else value="0" @endif >
                                            </td>
                                            <td style="padding-top: 0.4cm">Diskon</td>
                                            <td >
                                                <input type="text" class="form-control" name="ed_diskon_m" style="text-align:right" readonly="readonly" tabindex="-1" @if ($do !== null) value="{{$do->diskon}}" @else value="0" @endif >
                                            </td>
                                            <td style="padding-top: 0.4cm">Total Net</td>
                                            <td >
                                                <input type="text" class="form-control" name="ed_total_net" style="text-align:right" readonly="readonly" tabindex="-1" @if ($do !== null) value="{{$do->total_net}}" @else value="0" @endif >
                                            </td>
                                        </tr>
                                    </tbody>
                                </table>
...
<script type="text/javascript">
    ...
    $(document).ready( function () {
        $("#ed_nomor").focus();
        $("select[name='cb_kota_asal']").val({{$do->id_kota_asal}}).trigger('chosen:updated');
            ...
            success: function(data, textStatus, jqXHR)
            {
                if(data.crud == 'N'){
                    if(data.result == 1){
                        ...
                        var total_net = parseFloat(data.total[0].total_net) + parseFloat(biaya_komisi) + parseFloat(biaya_tambahan) - parseFloat(data.total[0].diskon);
