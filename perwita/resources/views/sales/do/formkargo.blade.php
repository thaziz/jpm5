                                        ...
                                        <table class="table table-striped table-bordered dt-responsive nowrap table-hover">
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td></td>
                                                    <td colspan="2" style="padding-bottom : 0.4cm">
                                                        <div class="checkbox">
                                                            <label>
                                                                <input type="checkbox" name="ck_ppn" id="ck_ppn"> PPN
                                                            </label>
                                                        </div>
                                                    </td>
                                                </tr>
...
<script type="text/javascript">
    ...
    $(document).ready( function () {
        ...
        $("select[name='cb_angkutan']").val('{{ $do->kode_angkutan or ''  }}').trigger('chosen:updated');
    ...
    function hitung(){
        ...
        var ppn  = parseFloat(total)/parseFloat(10)    ;
