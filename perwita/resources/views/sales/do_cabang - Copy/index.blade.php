        ...
        <div class="col-lg-12" >
            <div class="ibox float-e-margins">
                <div class="ibox-title">
                    <h5 style="margin : 8px 5px 0 0"> DELIVERY ORDER
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="btn-group">
                                        ...
                                        <a href="updatestatusordercabang" data-toggle="tooltip" title="Update Status" class="btn btn-warning btn-xs btnedit"><i class="fa fa-cog"></i></a>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="btn-group">
                                        <a href="" data-toggle="tooltip" title="Edit" class="btn btn-warning btn-xs btnedit"><i class="fa fa-pencil"></i></a>
                                        <a href="" data-toggle="tooltip" title="Print" class="btn btn-warning btn-xs btnedit"><i class="fa fa-print"></i></a>
                                        <a href="" data-toggle="tooltip" title="Update Status" class="btn btn-warning btn-xs btnedit"><i class="fa fa-cog"></i></a>
                                        <a href="" data-toggle="tooltip" title="Delete" class="btn btn-xs btn-danger"><i class="fa fa-times"></i></a>
                                    </div>
                                </td>
                            </tr>
...
<script type="text/javascript">
    $(document).on("click","#btn_add_order",function(){
        window.location.href = baseUrl + '/sales/deliveryordercabangform'
    });
