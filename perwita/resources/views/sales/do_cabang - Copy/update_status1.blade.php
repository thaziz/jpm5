                       ...
                       <!--  <div class="form-group">
                          ...
                          <form action="" class="form-horizontal" method="post" >
                              <table class="table table-striped table-bordered dt-responsive nowrap table-hover">
                                  <tbody>
                                      <tr>
                                          <td style="width:110px; padding-top: 0.4cm">Nomor Surat Jalan</td>
                                          <td colspan = "5">
                              ...
                              <div class="row">
                                <div class="col-md-4">
                                    <button type="button" class="btn btn-primary " id="btnadd" name="btnadd"><i class="fa fa-plus"></i> Update Status</button>
                                </div>
