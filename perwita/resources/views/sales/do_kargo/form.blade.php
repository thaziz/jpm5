                                    ...
                                    <div class="col-md-6">
                                        <table class="table table-striped table-bordered dt-responsive nowrap table-hover">
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td colspan="3">
                                                        ...
                                                        @foreach ($customer as $row)
                                                            <option value="{{ $row->kode }}" data-tipe="{{$row->tipe}}" > {{ $row->nama }} </option>
                                                        @endforeach
                                                        </select>
                                                    </td>
                                                </tr>
												<!--
                                                <tr>
                                                    <td style="padding-top: 0.4cm">Tipe Customer</td>
                                                    <td colspan="3">
                                                        <input type="text" class="form-control" name="ed_tipe_customer" style="text-transform: uppercase" readonly="readonly" tabindex="-1" >
                                                    </td>
												--!>
                                                <tr>
                                        ...
                                        <table class="table table-striped table-bordered dt-responsive nowrap table-hover">
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td colspan="3">
														<select class="chosen-select-width B"  name="cb_nopol" id="cb_nopol">
														</select>
                                        ...
                                        <table id="table_data" class="table table-striped table-bordered table-hover">
                                            <tbody>
                                                ...
                                                <tr id="kargo">
                                                    ...
                                                    <td style="padding-top: 0.4cm">Nopol</td>
                                                    <td>
                                                        <select class="chosen-select-width"  name="cb_nopodddl" style="width:100%">
                                                            <option class="Ba"></option>
                                                        </select>
                                                    </td>
                                                </tr>
                                                <tr id="dimensi">
...
<script type="text/javascript">
    ...
    $(document).ready( function () {
        ...
        $("select[name='cb_tipe_angkutan']").change();
    ...
    $('#cb_customer').change(function(){
        ...
        $.ajax(
        {
            ...
            //    $("input[name='ed_tipe_customer']").val(data.alamat);
    ...
    $("select[name='cb_status_kendaraan']").change(function(){
        var value = {
            tipe_angkutan: $("select[name='cb_tipe_angkutan']").val(),
            status_kendaraan : $("select[name='cb_status_kendaraan']").val(),
        };
        $.ajax(
        {
            url : baseUrl + "/sales/deliveryorderkargoform/tampil_nopol",
            type: "GET",
            data : value,
            dataType:'json',
            success: function(data, textStatus, jqXHR)
            {
				$("#cb_nopol").empty();
				$('.B').append(data);
				$("#cb_nopol").trigger("chosen:updated");
            },
            error: function(jqXHR, textStatus, errorThrown)
            {
               // swal("Error!", textStatus, "error");
    ...
    $("select[name='cb_tipe_angkutan']").change(function(){
        var value = {
            tipe_angkutan: $("select[name='cb_tipe_angkutan']").val(),
            status_kendaraan : $("select[name='cb_status_kendaraan']").val(),
        };
