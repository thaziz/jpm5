		...
		<div class="pembungkus">
			<table class="size textcenter  table-responsive" width="100%">
				...
				<tr>
					...
					<td class="borderbottomtabel borderrighttabel">{{$row->dd_jumlah}}&nbsp;{{$row->dd_kode_satuan}}</td>
					<td class="textright borderbottomtabel borderrighttabel"> {{ number_format($row->dd_harga, 2, ",", ".") }} </td>
