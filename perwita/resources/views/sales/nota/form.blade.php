        ...
        <div class="col-lg-12" >
            <div class="ibox float-e-margins">
                <div class="ibox-title">
                    <h5 style="margin-left : 5px"> INVOICE PENJUALAN
                          ...
                          <form action="" class="form-horizontal" method="post" >
                              <table class="table table-striped table-bordered dt-responsive nowrap table-hover">
                                  <tbody>
                                      ...
                                      <tr>
                                          <td style="padding-top: 0.4cm">Tgl / Tgl JT </td>
                                          <td>
                                      ...
                                      <tr >
                                          <td style="padding-top: 0.4cm">NPWP Tax</td>
                                          <td colspan = "3"><input type="text" class="form-control" id="edtotaljualh" name="edtotaljualh" value="" ></td>
                                      </tr>
                                      <tr>
                                      ...
                                      <tr>
                                          ...
                                          <td colspan = "3"><input type="text" class="form-control" id="edtotaljualh" name="edtotaljualh" value="" style="text-align:right" disabled="disabled"></td>
                                      </tr>
                                      <tr>
                        ...
                        <div class="modal-dialog modal-lg">
                          <div class="modal-content">
                            <div class="modal-header">
                              ...
                              <h4 class="modal-title">Insert Edit Nota Penjaulan</h4>
                            </div>
                              ...
                              <form class="form-horizontal">
                                <table id="table_data" class="table table-striped table-bordered table-hover">
                                  <tbody>
                                      <tr>
                                          <tr>
                                              <td style="width:120px; padding-top: 0.4cm">No DO</td>
                                              <td>
                        ...
                        <div id="modal_pilih_nomor_so" class="modal" >
                          <div class="modal-dialog">
                            <div class="modal-content">
                              <div class="modal-header">
                                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                                <h2>Pilih Nomor DO dari Pelanggan 1</h2>
                              </div>
                              <div class="modal-body">
                                <form class="form-horizontal">
                                    <table id="table_data" class="table table-striped table-bordered table-hover">
