        ...
        <div class="col-lg-12" >
            <div class="ibox float-e-margins">
                <div class="ibox-title">
                    <h5>Daftar Tenaga Kerja Outsourching  
            ...
            <div class="col-xs-12">
              ...
              <div class="box" id="#">
                <div class="row">
                    ...
                    <div class="col-md-2"><a type="button" class="btn btn-box-tool" style="color: #888; font-size:12pt;" title="tambahkan data item" href="{{url('master_hrd/create3')}}"><i class="fa fa-plus" aria-hidden="true"></i> &nbsp;Tambah Data</a> 
                      ...
                      <tr>
                        ...
                        <td class="text-center">
                          ...
                          <ul class="dropdown-menu" aria-labelledby="dropdownMenu1">
                            <li><a href="{{url('master_hrd/edit3')}}"><i class="fa fa-pencil" aria-hidden="true"></i> Ubah Item</a></li>
