                  ...
                  <form class="form-horizontal">
                    <div class="form-group">
                      <label class="control-label col-sm-2" for="nik">NIK</label>
                        <div class="col-sm-8">
                          <input type="text" class="form-control" id="nik" placeholder="value nik pegawai">
                        </div>
                    </div>
                        <div class="form-group">
                    ...
                    <div class="form-group">
                      <label class="control-label col-sm-2" for="nama">Nama Lengkap</label>
                        <div class="col-sm-8">
                          <input type="text" class="form-control" id="nama" placeholder="value nama pegawai">
                        </div>
                    </div>
                     <div class="form-group">
                      <label class="control-label col-sm-2" for="bagian">Bagian</label>
                        <div class="col-sm-8">
                          <input type="text" class="form-control" id="bagian" placeholder="value bagian pegawai">
                        </div>
                    </div>
                     <div class="form-group">
                      <label class="control-label col-sm-2" for="bagian">Bagian</label>
                    ...
                    <div class="form-group">
                      <label class="control-label col-sm-2" for="pendidikan">Pendidikan</label>
                        <div class="col-sm-8">
                          <input type="text" class="form-control" id="pendidikan" placeholder="value pendidikan pegawai">
                        </div>
                    </div>
                    <div class="form-group">
                      <label class="control-label col-sm-2" for="alamat">Alamat Lengkap</label>
                        <div class="col-sm-8">
                          <input type="text" class="form-control" id="alamat" placeholder="value alamat pegawai">
                        </div>
                    </div> 
                     <div class="form-group">
                      <label class="control-label col-sm-2" for="tlp">No.Tlp</label>
                        <div class="col-sm-8">
                          <input type="text" class="form-control" id="tlp" placeholder="value tlp pegawai">
                        </div>
                    </div>
                    <div class="form-group">
                      <label class="control-label col-sm-2" for="ktp">No KTP</label>
                        <div class="col-sm-8">
                          <input type="text" class="form-control" id="ktp" placeholder="value ktp pegawai">
                        </div>
                    </div>
                    <div class="form-group">
                      <label class="control-label col-sm-2" for="norek">NO rekening</label>
                        <div class="col-sm-8">
                          <input type="text" class="form-control" id="norek" placeholder="value norek pegawai">
                        </div>
                    </div>
                    <div class="form-group">
                      <label class="control-label col-sm-2" for="nokpk">NO KPK</label>
                        <div class="col-sm-8">
                          <input type="text" class="form-control" id="nokpk" placeholder="value nokpk pegawai">
                        </div>
                    </div>
                    <div class="form-group">
                      <label class="control-label col-sm-2" for="nopj">NO PJ</label>
                        <div class="col-sm-8">
                          <input type="text" class="form-control" id="nopj" placeholder="value nopj pegawai">
                        </div>
                    </div>
                     <div class="form-group">
                      <label class="control-label col-sm-2" for="nokpj">NO KPJ</label>
                        <div class="col-sm-8">
                          <input type="text" class="form-control" id="nokpj" placeholder="value nokpj pegawai">
                        </div>
                    </div>
                    <div class="form-group">
                      <label class="control-label col-sm-2" for="namaortu">Nama Ortu (ibu)</label>
                        <div class="col-sm-8">
                          <input type="text" class="form-control" id="namaortu" placeholder="value namaortu pegawai">
                        </div>
                    </div>
                    <div class="form-group"> 
                      <div class="col-sm-offset-2 col-sm-10">
                        <button type="submit" class="btn btn-default">Submit</button>
                        <a href="{{ url('master_hrd/index2 ') }}"<button type="button" class="btn btn-md btn-danger" title="kembali">Kembali</button></a>
                      </div>
                    </div>
                  </form>
                </div><!-- /.box-body -->
