        ...
        <div class="col-lg-12" >
            <div class="ibox float-e-margins">
                <div class="ibox-title">
                    <h5>Form Tambah Tenaga Kerja Outsourcing 
                  ...
                  <form class="form-horizontal">
                    ...
                    <div class="form-group">
                     ...
                     <div class="form-group">
                      <label class="control-label col-sm-2" for="bagian">Bagian</label>
                        <div class="col-sm-8">
                          <input type="text" class="form-control" id="bagian" placeholder="bagian tenaga kerja">
                        </div>
                    </div>
                     <div class="form-group">
                    ...
                    <div class="form-group">
                      <label class="control-label col-sm-2" for="pendidikan">Pendidikan</label>
                        <div class="col-sm-8">
                          <input type="text" class="form-control" id="pendidikan" placeholder="pendidikan tenaga kerja">
                        </div>
                    </div>
                    <div class="form-group">
                      <label class="control-label col-sm-2" for="alamat">Alamat Lengkap</label>
                        <div class="col-sm-8">
                          <input type="text" class="form-control" id="alamat" placeholder="alamat tenaga kerja">
                        </div>
                    </div> 
                     <div class="form-group">
                      <label class="control-label col-sm-2" for="tlp">No.Tlp</label>
                        <div class="col-sm-8">
                          <input type="text" class="form-control" id="tlp" placeholder="tlp tenaga kerja">
                        </div>
                    </div>
                    <div class="form-group">
                      <label class="control-label col-sm-2" for="ktp">No KTP</label>
                        <div class="col-sm-8">
                          <input type="text" class="form-control" id="ktp" placeholder="ktp tenaga kerja">
                        </div>
                    </div>
                    <div class="form-group">
                      <label class="control-label col-sm-2" for="eksktp">Expired KTP</label>
                        <div class="col-sm-8">
                          <input type="text" class="form-control" id="eksktp" placeholder="eksktp tenaga kerja">
                        </div>
                    </div>
                     <div class="form-group">
                      <label class="control-label col-sm-2" for="nokpj">NO KPJ</label>
                        <div class="col-sm-8">
                          <input type="text" class="form-control" id="nokpj" placeholder="nokpj tenaga kerja">
                        </div>
                    </div>
                    <div class="form-group">
                      <label class="control-label col-sm-2" for="namaortu">Nama Ortu (ibu)</label>
                        <div class="col-sm-8">
                          <input type="text" class="form-control" id="namaortu" placeholder="namaortu tenaga kerja">
                        </div>
                    </div>
                    <div class="form-group"> 
