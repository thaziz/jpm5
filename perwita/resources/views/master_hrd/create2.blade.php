                  ...
                  <form class="form-horizontal">
                    <div class="form-group">
                      <label class="control-label col-sm-2" for="nik">NIK</label>
                        <div class="col-sm-8">
                          <input type="text" class="form-control" id="nik" placeholder="nik pegawai">
                        </div>
                    </div>
                        <div class="form-group">
                    ...
                    <div class="form-group">
                     ...
                     <div class="form-group">
                      <label class="control-label col-sm-2" for="bagian">Bagian</label>
                        <div class="col-sm-8">
                          <input type="text" class="form-control" id="bagian" placeholder="bagian pegawai">
                        </div>
                    </div>
                     <div class="form-group">
                    ...
                    <div class="form-group">
                      <label class="control-label col-sm-2" for="tempat kerja">Tempat Lahir</label>
                        <div class="col-sm-8">
                          <input type="text" class="form-control" id="tmpat lahit" placeholder="tempat lahir">
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                      <label class="control-label col-sm-2" for="pendidikan">Pendidikan</label>
                        <div class="col-sm-8">
                          <input type="text" class="form-control" id="pendidikan" placeholder="pendidikan pegawai">
                        </div>
                    </div>
                    <div class="form-group">
                      <label class="control-label col-sm-2" for="alamat">Alamat Lengkap</label>
                        <div class="col-sm-8">
                          <input type="text" class="form-control" id="alamat" placeholder="alamat pegawai">
                        </div>
                    </div> 
                     <div class="form-group">
                      <label class="control-label col-sm-2" for="tlp">No.Tlp</label>
                        <div class="col-sm-8">
                          <input type="text" class="form-control" id="tlp" placeholder="tlp pegawai">
                        </div>
                    </div>
                    <div class="form-group">
                      <label class="control-label col-sm-2" for="ktp">No KTP</label>
                        <div class="col-sm-8">
                          <input type="text" class="form-control" id="ktp" placeholder="ktp pegawai">
                        </div>
                    </div>
                    <div class="form-group">
                      <label class="control-label col-sm-2" for="norek">NO rekening</label>
                        <div class="col-sm-8">
                          <input type="text" class="form-control" id="norek" placeholder="norek pegawai">
                        </div>
                    </div>
                    <div class="form-group">
                      <label class="control-label col-sm-2" for="nokpk">NO KPK</label>
                        <div class="col-sm-8">
                          <input type="text" class="form-control" id="nokpk" placeholder="nokpk pegawai">
                        </div>
                    </div>
                    <div class="form-group">
                      <label class="control-label col-sm-2" for="nopj">NO PJ</label>
                        <div class="col-sm-8">
                          <input type="text" class="form-control" id="nopj" placeholder="nopj pegawai">
                        </div>
                    </div>
                     <div class="form-group">
                      <label class="control-label col-sm-2" for="nokpj">NO KPJ</label>
                        <div class="col-sm-8">
                          <input type="text" class="form-control" id="nokpj" placeholder="nokpj pegawai">
                        </div>
                    </div>
                    <div class="form-group">
                      <label class="control-label col-sm-2" for="namaortu">Nama Ortu (ibu)</label>
                        <div class="col-sm-8">
                          <input type="text" class="form-control" id="namaortu" placeholder="namaortu pegawai">
                        </div>
                    </div>
                    <div class="form-group"> 
