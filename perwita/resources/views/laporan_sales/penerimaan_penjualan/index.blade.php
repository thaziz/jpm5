                          ...
                          <div class="row">
                              <table class="table table-striped table-bordered dt-responsive nowrap table-hover">
                                <tbody>
                                    ...
                                    <tr>
                                        <td colspan = "4" >
                                            <button style="width:100%;" type="button" class="btn btn-success " id="btn_add" name="btnok"><i class="glyphicon glyphicon-plus"></i>Add Penerimaan Penjualan</button>
                                        </td
                                    </tr>
                                </tbody>
                            </table>
                  ...
                  <table id="seragam_table" class="table table-bordered table-striped">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>Uang muka invoice nomor 100001</td>
                            <td>1300000.00</td>
                            <td>
                                <div class="btn-group">
                        ...
                        <tr>
                            ...
                            <td>22/07/2017</td>
                            <td>PT. SUPER WAHANA TEHNO</td>
                            <td>Pelunasan Invoice Nomor 100001</td>
                            <td>148800.00</td>
                            <td>
                                <div class="btn-group">
                                    <a href="" data-toggle="tooltip" title="Edit" class="btn btn-warning btn-xs btnedit"><i class="fa fa-pencil"></i></a>
                        ...
                        <tr>
                            ...
                            <td>Pelunasan Invoice Nomor 100050</td>
                            <td>40000.00</td>
                            <td>
                                <div class="btn-group">
                                    <a href="" data-toggle="tooltip" title="Edit" class="btn btn-warning btn-xs btnedit"><i class="fa fa-pencil"></i></a>
                        ...
                        <tr>
                            ...
                            <td>22/07/2017</td>
                            <td>BINA PUTRA MANDIRI</td>
                            <td>Pelunasan Invoice Nomor 100401</td>
                            <td>40000.00</td>
                            <td>
                                <div class="btn-group">
                                    <a href="" data-toggle="tooltip" title="Edit" class="btn btn-warning btn-xs btnedit"><i class="fa fa-pencil"></i></a>
                        ...
                        <tr>
                            ...
                            <td>Pelunasan Invoice Nomor 110001</td>
                            <td>40000.00</td>
                            <td>
                                <div class="btn-group">
                                    <a href="" data-toggle="tooltip" title="Edit" class="btn btn-warning btn-xs btnedit"><i class="fa fa-pencil"></i></a>
                        ...
                        <tr>
                            ...
                            <td>22/07/2017</td>
                            <td>PT. SUPER WAHANA TEHNO</td>
                            <td>Pembayaran Invoice Nomor 200001</td>
                            <td>40000.00</td>
                            <td>
                                <div class="btn-group">
                                    <a href="" data-toggle="tooltip" title="Edit" class="btn btn-warning btn-xs btnedit"><i class="fa fa-pencil"></i></a>
...
<script type="text/javascript">
    ...
    $(document).on("click","#btn_add",function(){
        window.location.href = baseUrl + '/sales/penerimaanpenjualanform'
    });
    function tambahdata() {
