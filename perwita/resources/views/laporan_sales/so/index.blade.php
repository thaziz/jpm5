                          ...
                          <div class="row">
                              <table class="table table-striped table-bordered dt-responsive nowrap table-hover">
                                <tbody>
                                    ...
                                    <tr>
                                        <td style="padding-top: 0.4cm">Keterangan DO</td>
                                        <td colspan="4">
                                            <select class="select2_single form-control" id="cbcustomer" name="cbcustomer" >
                                                <option>Semua Data</option>
                                                <option>Sudah di Pakai delivery order (DO)</option>
                                                <option>Belum di Pakai delivery order (DO)</option>
                                            </select>
                                        </td>
                                    </tr>
                                    <tr>
...
<script type="text/javascript">
    ...
    $(document).on("click","#btn_add_order",function(){
        //window.location.href = baseUrl + '/sales/salesorderform'
    });
    function tambahdata() {
