              ...
              <div class="box" id="seragam_box">
                ...
                <div class="box-body">
                  <table id="table_data" class="table table-bordered table-striped">
                    <thead>
                        <tr>
                            <td style="width:17%">No Invoice</td>
                            <td style="width:12%">Tanggal</td>
                            <td style="width:12%">Jatuh Tempo</td>
                            <td style="width:10%">Tagihan</td>
...
<script type="text/javascript">
    ...
    $(document).on("click","#btn_ok",function(){
        ...
        $.ajax(
        {
            url : baseUrl + "/laporan_sales/analisa_piutang/tampil_data",
            type: "GET",
            dataType:"JSON",
            data : value,
