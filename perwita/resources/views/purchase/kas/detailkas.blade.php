...
<div style="margin:0 10;">
	...
	<table border="1" style="border-collapse: collapse;">
		...
		<tbody >
			...
			<td align="right" style="min-width: 100px;"> {{"Rp " . number_format($val->bpkd_tarif,0,",",".")}}</td>
			<td align="right" style="min-width: 40px;">{{"" . number_format($val->bpkd_tarif_penerus,0,",",".")}}</td>
			</tr>
			@endforeach
			<tr>
			<td align="right" colspan="7">Total :</td>
			<td align="right" style="font-size: 10px;">{{"Rp " . number_format($cari[0]->bpk_total_tarif,0,",",".")}}</td>
			<td style="font-size: 12px;" align="right">{{"Rp " . number_format(round($total_harga),0,",",".")}}</td>
			</tr>
			<tr>
