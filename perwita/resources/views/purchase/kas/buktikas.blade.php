...
<table border="1" style="border-collapse: collapse;">
	<td width="900">
		...
		<div style="display: inline-block; margin-left: 32%">
			...
			<p style="font-size: 12px; text-align: center; margin-top: 3px;margin-bottom: 20px;">{{$cari[0]->alamat}}<br>Telp :{{$cari[0]->telpon}}<br>Fax :{{$cari[0]->fax}}</p>
			<h5 style="margin-top: 0; margin-bottom:2;text-align: center;">BUKTI PENGELUARAN KAS</h5>
		</div>
		<div style="float: right;">
			<p style="margin: 0 0;font-size: 14px; margin-top: 5px; margin-right: 5px;">No&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:<br>{{$cari[0]->bpk_nota}}<br>Tanggal&nbsp;: {{$cari[0]->bpk_tanggal}}<br>Cabang&nbsp;&nbsp;:{{$cari[0]->nama}}</p>
		</div>
	</td>
</table>
<table border="1" style="border-collapse: collapse; margin: 5 0">
	<td width="900">
		<div>DIBAYAR KEPADA&nbsp;:&nbsp;{{$cari[0]->bpk_sopir}}</div>
	</td>
</table>
...
<table border="1" style="border-collapse: collapse; margin: 5 0; margin-bottom: 0;">
	...
	<tbody style="padding: 0 0 ">
		...
		@else	
			@if($index+1 < 10)
		<td align="left" style="border: none;" width="222">&nbsp;&nbsp;&nbsp;{{$index+1}}. {{$akun_biaya[$index]}}</td>
			@else
		<td align="left" style="border: none;" width="222">&nbsp;&nbsp;{{$index+1}}. {{$akun_biaya[$index]}}</td>	
			@endif
		@endif
