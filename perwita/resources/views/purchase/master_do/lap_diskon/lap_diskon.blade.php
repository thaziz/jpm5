                ...
                <div class="col-xs-12">
                  <table class="table table-bordered datatable table-striped">
                      ...
                      <tr>                                                     
                        <th> Jenis : </th> 
                          <td colspan="4">  
                                <input id="jenis" type="text" class="form-control ">
                          </td>
                      </tr>
                      <tr>
                        <th> Pilih Laporan</th>
                  ...
                  <table id="addColumn" class="table table_header table-bordered table-striped"> 
                    ...
                    <tr>
                      <td>{{ $index+1 }} </td>
                      <td>{{ $element->dc_kode }}  </td>
                      <td>{{ $element->dc_note }}  </td>
                      <td>{{ $element->cabang }} </td>
                      <td>{{ $element->dc_jenis }} </td>
                      <td>{{ $element->dc_diskon }} (%)</td>
                      <td hidden=""><input type="hidden" name="" value="{{ $element->dc_id }}"></td>
                      </tr>
                    @endforeach
                    </tbody>
                  </table>
       ...
       buttons: [
          {
               ...
               /* messageTop: 'Hasil pencarian dari Nama : ',*/
                text: ' Excel',
                className:'excel',
                title:'LAPORAN MASTER DISKON',
                filename:'DISKON-'+a+b+c,
    ...
    function cetak(){
     ...
     var asw=[];
      ...
      $.ajax({
        ...
        url: baseUrl + '/reportdiskon/reportdiskon',
         type: "post",
