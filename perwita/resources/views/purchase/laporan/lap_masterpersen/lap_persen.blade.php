                        ...
                        <tr id="filter_col1" data-column="0">
                         ...
                         <th> Pilih Laporan : </th>
                          <td >
                            ...
                            <option value="{{ url('/masterdepartment/masterdepartment') }}">Laporan Data Department</option>
                            <option value="{{ url('/lap_masterpresentase/lap_masterpresentase') }}">Laporan Data Persentase</option>
                    ...
                    <tbody>
                      @foreach ($array as $index => $element)
                        <tr>
                          ...
                          <td hidden="" align="center"><input type="hidden" name="" value="{{ $element->kode }}">{{ $element->kode }}</td>
                          <td align="center">{{ $element->nama }}</td>
                          <td align="center">{{ $element->cabang }}</td>
                          <td align="center">{{ $element->keterangan }}</td>
                          <td align="center">{{ $element->persen }}</td>
                          <td align="center">{{ $element->jenis_biaya }}</td>
                          <td align="center">{{ $element->kode_akun }}</td>
                        </tr>
                      @endforeach
                    </tbody>
       ...
       buttons: [
          {
               ...
               /* messageTop: 'Hasil pencarian dari Nama : ',*/
                text: ' Excel',
                className:'excel',
                title:'LAPORAN MASTER PERSENTASE',
                filename:'PERSENTASE-'+a+b+c,
  ...
  function cetak(){
     var asw=[];
      ...
      $.ajax({
        ...
        url: baseUrl + '/reportmasterpresentase/reportmasterpresentase',
       type: "post",
