                ...
                <div class="box-body">
                  ...
                  <table id="addColumn" class="table table-bordered table-striped tbl-item">
                    ...
                    @foreach($data as $index=>$data)
                      <tr>
                        <td>{{ $index+1 }}</td>
                        <td><input type="hidden" name="" value="{{ $data->spp_nospp }}">{{ $data->spp_nospp }}</td>
                        <td>{{ $data->spp_keperluan }}</td>
                        <td>{{ $data->spp_bagian }}</td>
                        <td>{{ $data->spp_tgldibutuhkan }}</td>
                        <td>{{ $data->nama }}</td>
                        <td>{{ $data->spp_status }}</td>
                      </tr>
                    @endforeach
                    </tbody>       
                  </table>
       ...
       buttons: [
          {
               ...
               /* messageTop: 'Hasil pencarian dari Nama : ',*/
                text: ' Excel',
                className:'excel',
                title:'LAPORAN SURAT PERMINTAAN PEMBELIAN',
                filename:'MASTERSPP-'+a+b+c,
