                    ...
                    <tbody>
                      @foreach ($array as $index => $element)
                        <tr>
                          ...
                          <td align="center"><input type="hidden" name="" value="{{ $element->mb_id }}">{{ $element->mb_id }}</td>
                          <td align="center">{{ $element->mb_nama }}</td>
                          <td align="center">{{ $element->mb_harga }}</td>
                        </tr>
                      @endforeach
                    </tbody>
  ...
  function cetak(){
     var asw=[];
      ...
      $.ajax({
        ...
        url: baseUrl + '/reportbbm/reportbbm',
       type: "post",
