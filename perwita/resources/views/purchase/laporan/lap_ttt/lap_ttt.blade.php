                  ...
                  <table class="table table-bordered table-striped">
                      ...
                      <br>
                       <tr>
                        ...
                        <th> Bagian : </th> 
                          <td> 
                                <input id="bagian" type="text" class="form-control ">
                          </td>  
                          <th> Status : </th> 
                            <td> 
                        ...
                        <tr>
                          ...
                          <td colspan="3">
                           <select class="form-control" onchange="location = this.value;">
                            ...
                            <option value="{{ url('/masteritem/masteritem/masteritem') }}" >Laporan Data Tanda Terima Tagihan</option>
                           </select>
                        </tr>
                    </table>
                    <hr>
                ...
                <div class="box-body">
                  ...
                  <table id="addColumn" class="table table-bordered table-striped tbl-item">
                    ...
                    @foreach($data as $index=>$data)
                      <tr>
                        <td>{{ $index+1 }}</td>
                        <td hidden=""><input type="hidden" name="" value="{{ $data->tt_idform }}"></td>
                        <td>{{ $data->tt_noform }}</td>
                        <td>{{ $data->tt_tgl }}</td>
                        <td>{{ $data->tt_idsupplier }}</td>
                        <td>{{ $data->tt_lainlain }}</td>
                        <td>{{ $data->tt_tglkembali }}</td>
                        <td>{{ $data->tt_totalterima }}</td> 
                        <td>{{ $data->tt_kwitansi }}</td>
                        <td>{{ $data->tt_suratperan }}</td>
                        <td>{{ $data->tt_suratjalanasli }}</td>
                        <td>{{ $data->tt_nofp }}</td>
                        <td>{{ $data->tt_idagen }}</td>
                        <td>{{ $data->tt_faktur }}</td>
                      </tr>
                    @endforeach
                    </tbody>       
                  </table>
       ...
       buttons: [
          {
               ...
               /* messageTop: 'Hasil pencarian dari Nama : ',*/
                text: ' Excel',
                className:'excel',
                title:'LAPORAN TANDA TERIMA TAGIHAN',
                filename:'TTT-'+a+b+c,
