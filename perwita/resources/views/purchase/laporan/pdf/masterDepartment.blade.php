		...
		<div class="col-sm-8 col-sm-offset-2">
			<div class="ibox float-e-margins">
				<div class="ibox-content">
					<a class="btn btn-info" href="{{ route('masterDepartment.ViewReport', ['download' => 'pdf']) }}">
						...
						<tr>
							<td colspan="3" style="padding: 0;">
								<table width="100%" style="height: 35px; padding: 0;" border="1">
									<tr>
										<td valign="middle" align="center" width="10%" height="45">NO</td>
										<td valign="middle" align="center" width="45%">K O D E</td>
										<td valign="middle" align="center" width="45%">D E P A R T M E N T</td>
									</tr>
									...
									@for ($index = 0; $index < count($masterDepartment["dept"]); $index++)
										<tr>
											...
											<td valign="middle" align="center">
												{{ $masterDepartment["kode"][$index] }}
											</td>

											<td valign="middle" align="center">
												{{ $masterDepartment["dept"][$index] }}
											</td>
										</tr>
									@endfor
								</table>
