     ...
     <tr>
       ...
       <td class="textright right" valign="top" height="300">
         ...
         @if($data['fpg'][0]->fpg_jenisbayar != '5')
           ...
           @foreach($data['fpg_dt'] as $fpgdt)
          <tr>
           <td> {{ number_format($fpgdt->fpgdt_pelunasan, 2) }} </td>
          </tr>
        ...
        <td class="textcenter top right" valign="top" height="300">
         ...
         @foreach($data['fpg_bank'] as $bg)
          <tr>
           <td>{{ number_format($bg->fpgb_nominal, 2) }}</td>
          </tr>
          @endforeach
         </table>
       </td>
