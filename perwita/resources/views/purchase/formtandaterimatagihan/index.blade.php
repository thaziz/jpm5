    ...
    <div class="row wrapper border-bottom white-bg page-heading">
                <div class="col-lg-10">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="active">
                            <strong> Form Tanda Terima Tagihan (TTT) </strong>
                        </li>
        ...
        <div class="col-lg-12" >
            <div class="ibox float-e-margins">
                <div class="ibox-title">
                    <h5> Form Tanda Terima Tagihan
                     <!-- {{Session::get('comp_year')}} -->
                     </h5>
                      <div class="text-right">
                       <a class="btn btn-success" aria-hidden="true" href="{{ url('formtandaterimatagihan/createformtandaterimatagihan')}}"> <i class="fa fa-plus"> Tambah Data  </i> </a> 
                    </div>
                </div>
                ...
                <div class="box-body">
                  ...
                  <table id="addColumn" class="table table-bordered table-striped tbl-penerimabarang">
                    ...
                    <tbody>
                      ...
                      <tr>
                        <td> 1 </td>
                        <td>  TTT-010/AP/1014 </td>
                        <td>  12 Juli 2015 </td>
                        <td> Surya Indah, Jl Gunung Anyar Sawahan </td>
                        <td>  </td>
                        <td> Senin, 11 Oktober 2017</td>
                        <td> <a class="btn btn-success" href={{url('formtandaterimatagihan/detailformtandaterimatagihan')}}><i class="fa fa-arrow-right" aria-hidden="true"></i> </a> </td>
