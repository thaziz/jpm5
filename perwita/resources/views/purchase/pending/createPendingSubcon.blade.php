          ...
          <table class="table table_header">
            ...
            <tr>
              ...
              <td>
                ...
                <input readonly="" class="form-control" type="hidden" value="{{$header->pb_acc}}" name="akun_agen">
            ...
            <tr>
              ...
              <td><input readonly="" class="form-control" type="text" value="{{$percent->persen}}%"></td>
            </tr>
            <tr>
              <td>Keterangan</td>
          ...
          <tbody>
            ...
            <tr>
              <td>
                ...
                <input type="hidden" class="bpd_id" value="{{$val->pbd_id}}">
                <input type="hidden" class="akun_biaya" value="{{$val->pbd_acc}}">
                <input type="hidden" class="dt_bpd ke_{{$val->pbd_pb_dt}}" name="dt_bpd" value="{{$val->pbd_pb_dt}}">
              </td>
              <td>{{$val->tanggal}}</td>
              <td>{{$val->asal}}</td>
              <td>{{$val->tujuan}}</td>
              <td>{{$val->status}}</td>
              <td>
                {{'Rp ' . number_format($val->pbd_tarif_resi,2,'.',',')}}
                <input type="hidden" class="tarif" name="tarif" value="{{$val->pbd_tarif_resi}}">
              </td>
              <td>
                {{'Rp ' . number_format($val->pbd_tarif_harga,2,'.',',')}}
                <input type="hidden" class="nominal" name="nominal" value="{{$val->pbd_tarif_harga}}">
              </td>
        ...
        <tbody>
          ...
          <tr>
            <td>
              {{$val->nomor}}
              <input type="hidden" class="id_bpd" name="id_bpd[]" value="{{$val->pbd_pb_id}}">
              <input type="hidden" class="dt_bpd" name="dt_bpd[]" value="{{$val->pbd_pb_dt}}">
              <input type="hidden" class="bpd_id" name="bpd_id[]" value="{{$val->pbd_id}}">
              <input type="hidden" class="bpd_akun_biaya_all" name="bpd_akun_biaya_all[]" value="{{$val->pbd_acc}}">
            </td>
            <td>{{'Rp ' . number_format($val->pbd_tarif_resi,2,'.',',')}}</td>
            <td>{{'Rp ' . number_format($val->pbd_tarif_harga,2,'.',',')}}</td>
