                    ...
                    <h5> Pelunasan Hutang / Pembayaran Bank
                     <!-- {{Session::get('comp_year')}} -->
                      ...
                      <div class="text-right">
                       <a class="btn btn-success" aria-hidden="true" href="{{ url('pelunasanhutangbayarbank/createpelunasanhutangbayarbank')}}"> <i class="fa fa-plus"> Tambah Data  </i> </a> 
                    </div>
                </div>
              ...
              <div class="box" id="seragam_box">
                ...
                <div class="box-body">
                  ...
                  <table id="addColumn" class="table table-bordered table-stripped tbl-penerimabarang">
                    ...
                    <td> <a class="btn btn-success text-right" href={{url('pelunasanhutangbayarbank/detailpelunasanhutangbayarbank')}}><i class="fa fa-arrow-right" aria-hidden="true"></i> </a>  </td>
                    </tr>
