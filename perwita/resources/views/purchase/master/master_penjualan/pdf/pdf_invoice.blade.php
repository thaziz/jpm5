                    ...
                    <tbody>
                      ...
                      @foreach ($data as $index =>$e)
                        ...
                        @if (condition)
                            {{-- expr --}}
                        @endif
                        <td align="right"><input type="hidden" value="{{ $e->i_netto+$e->i_ppnrp+$e->i_pajak_lain }}" class="total_netto" name="">{{ number_format($e->i_netto+$e->i_ppnrp+$e->i_pajak_lain,0,',','.') }}</td>

                        <td align="right"><input type="hidden" value="{{ $e->i_netto }}" class="total_netto_detil" name="">{{ number_format($e->i_netto,0,',','.') }}</td>
