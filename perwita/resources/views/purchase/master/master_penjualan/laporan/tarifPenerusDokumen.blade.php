                ...
                <div class="box-body">
                  ...
                  <table id="addColumn" class="table table-bordered table-striped tbl-item">
                    ...
                    <tbody>
                      ...
                      <tr> 
                        <td>{{ $index+1 }}</td>
                        <td><input type="hidden" name="" value="{{$val->id_tarif_dokumen}}">{{$val->id_tarif_dokumen}}</td>
                        <td>{{$val->asal}}</td>
                        <td>{{$val->tujuan}}</td>
                        <td align="center">{{$val->kecamatan}}</td>
                        <td align="right">{{"Rp " . number_format($val->harga_reg,2,",",".")}}</td>
                        <td align="right">{{"Rp " . number_format($val->harga_ex,2,",",".")}}</td>
         ...
         buttons: [
            {
                 ...
                 /* messageTop: 'Hasil pencarian dari Nama : ',*/
                  text: ' Excel',
                  className:'excel',
                  title:'LAPORAN TARIF PENERUS DOKUMEN',
                  filename:'PENERUSDOKUMEN-'+a+b+c,
