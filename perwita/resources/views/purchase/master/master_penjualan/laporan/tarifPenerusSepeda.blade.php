                  ...
                  <table id="addColumn" class="table table-bordered table-striped tbl-item">
                   <thead>
                    ...
                    <tbody>
                      ...
                      <tr> 
                        <td>{{ $index+1 }}</td>
                        <td><input type="hidden" name="" value="{{$val->id_tarif_sepeda}}">{{$val->id_tarif_sepeda}}</td>
                        <td>{{$val->prov}}</td>
                        <td>{{$val->kot}}</td>
         ...
         buttons: [
            {
                 ...
                 /* messageTop: 'Hasil pencarian dari Nama : ',*/
                  text: ' Excel',
                  className:'excel',
                  title:'LAPORAN TARIF PENERUS SEPEDA',
                  filename:'PENERUSSEPEDA-'+a+b+c,
   ...
   function filterColumn () {
    ...
    $('.select-picker1').change(function(){
      ...
      $.ajax({
        ...
        url: baseUrl + '/reportpenerussepeda/reportpenerussepeda',
        type: "post",    
