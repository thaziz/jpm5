                ...
                <div>
                  <div class="form-group col-md-4">
                      <select class="cari_semua chosen-select-width laporan" id="jenis"  name="jenis">
                        ...
                        <option value="KWITANSI BELUM POSTING">KWITANSI BELUM POSTING</option>
                        <option value="KWITANSI SUDAH POTING">KWITANSI SUDAH POTING</option>
                      </select>
                    </div>
...
<script type="text/javascript">
  ...
  $('.date').datepicker({
    ...
    function cari(){
      ...
      else if (laporan == 'KWITANSI BELUM POSTING') {
        $.ajax({
          data: {awal:awal,akir:akir,customer:customer,cabang:cabang},
          url: ('{{ route('cari_ajaxkwitansi_belum_posting') }}'),
          type: "get",
           success : function(data){
            $('#drop_here').html(data);
          }
      ...
      else if (laporan == 'KWITANSI SUDAH POTING') {
        $.ajax({
          data: {awal:awal,akir:akir,customer:customer,cabang:cabang},
          url: ('{{ route('cari_ajaxkwitansi_sudah_posting') }}'),
          type: "get",
           success : function(data){
            $('#drop_here').html(data);
          }
