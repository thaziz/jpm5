                  ...
                  <table class="table table-bordered datatable table-striped">
                      <br>
                        ...
                        <tr id="filter_col0" data-column="0">
                          ...
                          <td colspan="2">
                            <select class="chosen-select-width col-sm-12 asal form-control column_filter"  name="filter_cabang" id="col0_filter" style="width:100%" >
                              <option> </option>
                              @foreach ($kota as $row)
                        ...
                        <tr id="filter_col1" data-column="1">
                          ...
                          <td colspan="2"> 
                           <select class="chosen-select-width col-sm-12 asal form-control column_filter"  name="filter_cabang" id="col1_filter" style="width:100%" >
                              <option> </option>
                              @foreach ($kota as $row)
                                  <option value="{{ $row->tujuan }}"> {{ $row->tujuan }} </option>
                              @endforeach
   ...
   function filterGlobal () {
    ...
    $(document).ready(function() {
     ...
     function cetak(){
      ...
      $.ajax({
        url: baseUrl + '/laporan_master_penjualan/tablekargo',
