 ...
 <div class="row wrapper border-bottom white-bg page-heading">
                <div class="col-lg-10">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="active">
                            <strong> Kontrak Supplier </strong>
                        </li>
                    ...
                    <h5> Kontrak Supplier
                     <!-- {{Session::get('comp_year')}} -->
                      ...
                      <div class="text-right">
                       <a class="btn btn-success" aria-hidden="true" href="{{ url('master_supplier/createkontraksupplier')}}"> <i class="fa fa-plus"> Tambah Data  </i> </a> 
                    </div>
                </div>
