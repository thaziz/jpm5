                    ...
                    <h5> Model Kendaraan
                     <!-- {{Session::get('comp_year')}} -->
                      ...
                      <div class="text-right">
                       <a class="btn btn-success" aria-hidden="true" href="{{ url('modelkendaraan/createmodelkendaraan')}}"> <i class="fa fa-plus"> Tambah Data Model Kendaraan </i> </a> 
                    </div>
                ...
                <div class="box-body">
                  ...
                  <table id="addColumn" class="table table-bordered table-striped tbl-item">
                    ...
                    <tr>
                      ...
                      <td> <a class="btn btn-success" href={{url('modelkendaraan/detailmodelkendaraan')}}><i class="fa fa-arrow-right" aria-hidden="true"> </td>
