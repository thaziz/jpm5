					  ...
					  <div class="row">
                        <div class="col-sm-6">
                          ...
                          <tr>
                            <td> Acc HPP </td>
                            <td>
                            <select class="chosen-select-width l accpersediaan" name="acc_persediaan" id="accpersediaan"> <option value="{{$item->acc_persediaan}}"> {{$item->acc_hpp}} </option> <!-- </option> <option value=""> Pilih Akun2 </option>  --></select>
