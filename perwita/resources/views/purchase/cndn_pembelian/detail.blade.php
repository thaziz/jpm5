    ...
    <div class="row wrapper border-bottom white-bg page-heading">
                <div class="col-lg-10">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="active">
                            <strong> Detail CN / DN Pembelian </strong>
                        </li>
        ...
        <div class="col-lg-12" >
            <div class="ibox float-e-margins">
                <div class="ibox-title">
                    <h5> Detail CN / DN Pembelian
                     <!-- {{Session::get('comp_year')}} -->
                     </h5>
                
                        <div class="text-right">
                       <a class="btn btn-danger" aria-hidden="true" href="{{ url('cndnpembelian/cndnpembelian')}}"> <i class="fa fa-arrow-circle-left"> </i> &nbsp; Kembali  </a> 
                    </div>  
              ...
              <div class="box" id="seragam_box">
                <div class="box-header">
                  ...
                  <div class="box-body">
                      ...
                      <h4> Detail Daftar CN / DN Pembelian </h4>
