...
<div class="row wrapper border-bottom white-bg page-heading">
                <div class="col-lg-10">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="active">
                            <strong> Detail Pelaporan Pajak Masukan </strong>
                        </li>
                ...
                <div class="ibox-title">
                    <h5> Pelaporan Faktur Pajak Masukan
                     <!-- {{Session::get('comp_year')}} -->
                       ...
                       <a class="btn btn-danger" aria-hidden="true" href="{{ url('pelaporanfakturpajakmasukan/pelaporanfakturpajakmasukan')}}"> <i class="fa fa-arrow-circle-left"> </i> &nbsp; Kembali  </a> 
                    </div>  
              ...
              <div class="box" id="seragam_box">
                <div class="box-header">
                  ...
                  <div class="box-body">
                   ...
                   <h3> Detail Pelaporan Faktur Pajak Masukan </h3>
