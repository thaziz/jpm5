...
<div class="row wrapper border-bottom white-bg page-heading">
                <div class="col-lg-10">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="active">
                            <strong> Pelaporan Pajak Masukan </strong>
                        </li>
        ...
        <div class="col-lg-12" >
            <div class="ibox float-e-margins">
                <div class="ibox-title">
                    <h5> Pelaporan Faktur Pajak Masukan
                     <!-- {{Session::get('comp_year')}} -->
                     </h5>
                      <div class="text-right">
                       <a class="btn btn-success" aria-hidden="true" href="{{ url('pelaporanfakturpajakmasukan/createpelaporanfakturpajakmasukan')}}"> <i class="fa fa-plus"> Tambah Data  </i> </a> 
                    </div>
                </div>
                  ...
                  <table id="addColumn" class="table table-bordered table-striped tbl-penerimabarang">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td>  Rp 7.821.346,00</td>
                        <td> PPn Masukan Des 2009 </td>
                      
                        
                        <td> <a class="btn btn-success" href={{url('pelaporanfakturpajakmasukan/detailpelaporanfakturpajakmasukan')}}><i class="fa fa-arrow-right" aria-hidden="true"></i> </a>  </td>
