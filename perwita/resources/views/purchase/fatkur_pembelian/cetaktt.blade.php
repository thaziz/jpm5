<div>
  ...
  <div style="display: inline-block; float: right;">
  	<p style="margin:0 0 ;">No.TT&nbsp;&nbsp;&nbsp;: {{$nota}}&nbsp;</p>
  ...
  <div style="display: inline-block;">
  	...
  	<label style="border-bottom: 1px solid;">{{$data[0]->nama}}&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</label>
  </div>
  <div style=" float: right;">
  	<p style=" display: inline-block">Alamat : </p>
  	<label  style="border-bottom: 1px solid;">{{$data[0]->alamat}}</label>
  </div>
  <div style="font-size: 14px">
  	...
  	<table style="font-size: 14px; margin-bottom: 10px;" >
  		<tr>
  			...
  			<td width="20"></td>
  			<td align="center" style="border: 1px solid black">{{$data[0]->tt_kwitansi}}</td>
  		</tr>
  		<tr>
  			<td>2.</td>
  			<td>Faktur Pajak</td>
  			<td width="20"></td>
  			<td align="center" style="border: 1px solid black">{{$data[0]->tt_faktur}}</td>
  		</tr>
  		<tr>
  			<td>3.</td>
  			<td>Surat Peranan Asli</td>
  			<td width="20"></td>
  			<td align="center" style="border: 1px solid black">{{$data[0]->tt_suratperan}}</td>
  		</tr>
  		<tr>
  			<td>4.</td>
  			<td>Surat Jalan Asli</td>
  			<td width="20"></td>
  			<td align="center" style="border: 1px solid black">{{$data[0]->tt_suratjalanasli}}</td>
  		</tr>
  	</table>
  </div>
  <div style="display: inline-block; float: right;">
