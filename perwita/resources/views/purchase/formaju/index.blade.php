...
<div class="row wrapper border-bottom white-bg page-heading">
                <div class="col-lg-10">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="active">
                            <strong> Form Pengajuan Cek / BG </strong>
                        </li>
        ...
        <div class="col-lg-12" >
            <div class="ibox float-e-margins">
                <div class="ibox-title">
                    <h5> Form Pengajuan Cek /  BG (AJU)
                     <!-- {{Session::get('comp_year')}} -->
                     </h5>
                      <div class="text-right">
                       <a class="btn btn-success" aria-hidden="true" href="{{ url('formaju/createformaju')}}"> <i class="fa fa-plus"> Tambah Data  </i> </a> 
                    </div>
                </div>
                  ...
                  <table id="addColumn" class="table table-bordered table-striped tbl-penerimabarang">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td> <a class="btn btn-success" href={{url('formaju/detailformaju')}}><i class="fa fa-arrow-right" aria-hidden="true"></i> </a>  </td>
