 ...
 <div class="row wrapper border-bottom white-bg page-heading">
                <div class="col-lg-10">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="active">
                            <strong> Memorial Purchase </strong>
                        </li>
                    ...
                    <h5> Memorial Purchase
                     <!-- {{Session::get('comp_year')}} -->
                      ...
                      <div class="text-right">
                       <a class="btn btn-success" aria-hidden="true" href="{{ url('memorialpurchase/creatememorialpurchase')}}"> <i class="fa fa-plus"> Tambah Data  </i> </a> 
                    </div>
                </div>
                  ...
                  <table id="addColumn" class="table table-bordered table-striped tbl-penerimabarang">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td> <a class="btn btn-success" href={{url('memorialpurchase/detailmemorialpurchase')}}><i class="fa fa-arrow-right" aria-hidden="true"></i> </a>  </td>
