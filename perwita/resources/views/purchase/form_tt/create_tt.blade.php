              ...
              <div class="box">
                <div class="box-body">
                  <form class="col-sm-12 form_header">
                    <table class="table table-bordered">
                      <tr>
                        ...
                        <td colspan="2">
                          <select  name="supplier" onchange="sup()" class="supplier form-control chosen-select-width">
                  ...
                  <div class="col-sm-12" align="right">
                    <button class="btn btn-success simpan_form"><i class="fa fa-save "> Save</i></button>
                  </div>
                </div><!-- /.box-body -->
