                    ...
                    <table class="table" border="0">
                      ...
                      <tr>
                       <td> {{$i + 1}} </td>
                        ...
                        <td class='disabled'> <select class="form-control lokasigudang chosen-select" name="lokasigudang[]"> @foreach($data['gudang'] as $gudang) <option value="{{$gudang->mg_id}}" @if($gudang->mg_id == $data['podtbarang'][$k][$i]->podt_lokasigudang) selected @endif> {{$gudang->mg_namagudang}}</option> @endforeach </select> </td> <!-- lokasi gudang -->

                        <td> @if($data['po'][0]->po_tipe != 'J') 
                            {{$data['podtbarang'][$k][$i]->nopol}}
                            @else
                              -
                            @endif
                        </td>
