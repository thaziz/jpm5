                ...
                <div class="ibox-title">
                    <h5>
                     ...
                     <div class="text-right">
                      @if(Auth::user()->punyaAkses('Kecamatan','tambah'))
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>   
                                                ...
                                                <select class="chosen-select-width" name="kota" id="kota" style="width:100%">
                                                    <option value=""></option>
                                                @foreach ($kota as $row)
                                ...
                                <tr>
                                    <td style="padding-top: 0.4cm">Nama Kecamatan</td>
                                    <td><input type="text" class="form-control" id="ed_kecamatan" style="text-transform:uppercase"></td>
                                </tr>
...
<script type="text/javascript">
    $(document).ready( function () {
        $('#table_data').DataTable({
            ...
            "retrieve" : true,
            "ajax": {
              "url" :  baseUrl + "/sales/kecamatan/tabel",
              "type": "GET"
            },
            "columns": [
            { "data": "id" },
    ...
    $(document).on( "click",".btnedit", function() {
        ...
        $.ajax(
        {
            url : baseUrl + "/sales/kecamatan/get_data",
            type: "GET",
            data : value,
            dataType:'json',
            success: function(data, textStatus, jqXHR)
            {
                ...
                $("#ed_id").val(data.id);
                $("#kota").val(data.id_kota).trigger('chosen:updated');
                $("#ed_kecamatan").val(data.nama);
    ...
    $(document).on("click","#btnsave",function(e){
        ...
        var id = $("#ed_id").val();
        var kecamatan = $("#ed_kecamatan").val();
        var kota = $("#kota").val();
        var crud   = $("#crud").val();
        if(id == '' || id == null ){
            Command: toastr["warning"]('Kolom "ID" tidak boleh kosong ', "Peringatan !")
        ...
        $.ajax(
        {
            url : baseUrl + "/sales/kecamatan/save_data",
            type: "POST",
            dataType:"JSON",
    ...
    $(document).on( "click",".btndelete", function() {
        ...
        $.ajax({
            type: "POST",
            url : baseUrl + "/sales/kecamatan/hapus_data",
            //dataType:"JSON",
            data: value,
            success: function(data, textStatus, jqXHR)
            {
