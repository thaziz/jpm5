 ...
 <div class="wrapper">
      ...
      <td class="bot" valign="top">
        <table>
          <tr>
            ...
            <td valign="top">{{-- <input type="text" name="" class="hiden hiddenborderright hiddenbordertop hiddenborderleft" value=""> --}}
                <table width="100%"> 
                    <tr>  
                      <td class="hiden">  
                          &nbsp;
          ...
          <tr>
            <td valign="top" class=" textleft">Tgl</td>
            <td valign="top">:</td>
            <td valign="top">
               <table width="100%"> 
                    <tr>  
   ...
   <table width="100%" class="size">
     <tr>
       ...
       <td width="10%" class="right botdouble textcenter">Q</td>
       <td width="10%" class="right botdouble textcenter">Harga Sat.</td>
