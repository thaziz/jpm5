                ...
                <form id="form_header" class="form-horizontal">
                    <table class="table table-striped table-bordered table-hover">
                        <tbody>
                            ...
                            <tr>
                                <td style="width:110px; padding-top: 0.4cm">Akun Kredit</td>
                                <td>
                                    <select class="form-control" name="cb_akun" id="cb_akun">
                        ...
                        <div class="modal-body">
                            <form class="form-horizontal detail">
                                <table id="table_data" class="table table-striped table-bordered table-hover">
                                    <tbody>
                                        <tr>
                                          <td style="width:120px; padding-top: 0.4cm">Akun Debet</td>
                                          <td>
                                                <select class="chosen-select-width" name="cb_akun_debet" id="cb_akun_debet" >
                                                    <option></option>
                                                @foreach ($akun as $row)
                                                    <option value="{{ $row->kode }}">{{ $row->nama }}</option>
                                                @endforeach
                                                ...
                                                <input type="hidden" name="ed_kode_akun_kredit">
...
<script type="text/javascript">
    $(document).ready( function () {
        ...
        $('#table_data').DataTable({
            ...
            "retrieve" : true,
            "ajax": {
                "url": baseUrl + "/keuangan/pengeluaranform/tabel_data_detail",
                "type": "GET",
    ...
    $(document).on("click","#btnadd",function(){
        ...
        $("input[name='ed_kode_akun_kredit']").val(kode_akun);
        ...
        $.ajax(
        {
            url :  baseUrl + "/keuangan/pengeluaranform/save_data",
            type: "POST",
            dataType:"JSON",
    ...
    $(document).on( "click",".btnedit", function() {
        ...
        $.ajax(
        {
            ...
            success: function(data, textStatus, jqXHR)
            {
                ...
                $("select[name='cb_akun_debet']").val(data.kode_akun_debet).trigger('chosen:updated');
    ...
    $(document).on("click","#btnsave",function(){
        $.ajax(
        {
            url : baseUrl + "/keuangan/pengeluaranform/save_data_detail",
            type: "POST",
            dataType:"JSON",
    ...
    $(document).on( "click",".btndelete", function() {
        ...
        $.ajax({
            type: "POST",
            url : baseUrl + "/keuangan/pengeluaranform/hapus_data_detail",
            dataType:"JSON",
            data: value,
            success: function(data, textStatus, jqXHR)
            {
