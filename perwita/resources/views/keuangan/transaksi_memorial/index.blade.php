  ...
  <div class="modal-dialog" style="width: 60%; min-height: 605px;">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title">Tambah Transaksi Memorial</h4>
        <input type="hidden" class="parrent"/>
      </div>
      <div class="modal-body">
...
<div id="modal_edit_transaksi" class="modal">
  <div class="modal-dialog" style="width: 60%; min-height: 605px;">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
        <h4 class="modal-title">Edit Transaksi Memorial</h4>
...
<script type="text/javascript">
  ...
  $(document).ready(function(){
    ...
    $('#modal_edit_transaksi').on('shown.bs.modal', function(){
        // alert($('#id').val());
        $.ajax(baseUrl+"/keuangan/transaksi_memorial/edit?id="+$('#id').val(), {
           timeout: 15000,
           dataType: "html",
           success: function (data) {
    ...
    $(".delete").click(function(evt){
      ...
      if(confirm){
        $.ajax(baseUrl+"/keuangan/transaksi_memorial/delete?id="+$(this).data('id'), {
           timeout: 15000,
           type: 'get',
           dataType: "json",
           success: function (data) {
