                                ...
                                @foreach($data as $dataAkun)
                                  <tr>
                                    ...
                                    <td class="text-center">
                                      ...
                                      <button class="btn btn-xs btn-success lihat_jurnal" data-toggle="tooltip" data-placement="left" title="Lihat Jurnal" data-id="{{ $dataAkun->jr_id }}"><i class="fa fa-balance-scale fa-fw"></i></button>
...
<script type="text/javascript">
  ...
  $(document).ready(function(){
    ...
    $('#modal_edit_transaksi').on('shown.bs.modal', function(){
        // alert($('#id').val());
        $.ajax(baseUrl+"/keuangan/jurnal_umum/edit?id="+$('#id').val(), {
           timeout: 15000,
           dataType: "html",
           success: function (data) {
    ...
    $(".delete").click(function(evt){
      ...
      if(confirm){
        $.ajax(baseUrl+"/keuangan/jurnal_umum/delete?id="+$(this).data('id'), {
           timeout: 15000,
           type: 'get',
           dataType: "json",
           success: function (data) {
