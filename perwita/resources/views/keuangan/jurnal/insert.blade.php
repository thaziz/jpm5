  ...
  <div class="col-md-7" style="border: 0px solid #ddd; border-radius: 5px; padding: 10px;">
    <table border="0" id="form-table" class="col-md-12">
      ...
      <tr id="info-referensi" style="display: none;">
        <td width="20%" class="text-left">Nomor Referensi <input type="hidden" name="type_transaksi" value="kas" readonly /> </td>
        <td colspan="2">
    ...
    <div class="col-md-12 m-t" style="padding: 10px; background: #eee;">
      <table border="0" id="form-table" class="col-md-12">
        ...
        <tr>
          ...
          <td width="35%" colspan="2">
            <select class="select_validate form-control chosen-select akun list-should-disabled" id="akun_lawan">
              <option value="---"> -- Pilih Akun Coa</option>
            </select>
          </td>
        </tr>
