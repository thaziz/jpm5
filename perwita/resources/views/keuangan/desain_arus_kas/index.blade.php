        ...
        <div class="col-lg-12" >
            <div class="ibox float-e-margins">
                <div class="ibox-title">
                    <h5> Data Desain Arus Kas
                     <!-- {{Session::get('comp_year')}} -->
                     </h5>
                    <div class="ibox-tools">
                        <a class="btn btn-sm btn-primary tambahAkun" href="{{ url('master_keuangan/desain_arus_kas/add')}}">
                          <i class="fa fa-plus"></i> &nbsp;Tambahkan Data Desain Arus Kas
                        </a>
                    </div>
                </div>
  ...
  <div class="modal-dialog ">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title">Tampilan Desain Arus Kas</h4>
...
<script type="text/javascript">
  ...
  $(document).ready(function(){
    ...
    $(".tampilkan").click(function(evt){
      ...
      $("#modal_tampilkan .modal-body").html('<center><small class="text-muted">Sedang Mengambil Data Tampilan Arus Kas...</small></center>');

      $.ajax(baseUrl+"/master_keuangan/desain_arus_kas/view/"+$(this).data("id"), {
         timeout: 15000,
         dataType: "html",
    ...
    $(".edit").click(function(evt){
      ...
      window.location = baseUrl+"/master_keuangan/desain_arus_kas/edit/"+$(this).data("id");
    ...
    $(".hapus").click(function(evt){
      ...
      if(prmpt)
        window.location = baseUrl+"/master_keuangan/desain_arus_kas/delete/"+$(this).data("id");
      else
        return false;
    ...
    $(".aktifkan").click(function(evt){
      ...
      $.ajax(baseUrl+"/master_keuangan/desain_arus_kas/aktifkan/"+$(this).data("id"), {
         timeout: 15000,
         dataType: "json",
         success: function (data) {
            if(data.status == "sukses"){
              alert("Desain Arus Kas Berhasil Digunakan.");
              window.location = baseUrl+"/master_keuangan/desain_arus_kas";
