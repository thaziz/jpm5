                ...
                <div class="ibox-title">
                    ...
                    <div class="ibox-tools">
                        <button class="btn btn-sm btn-primary tambahAkun" data-toggle="modal" data-target="#modal_tambah_akun">
                          <i class="fa fa-plus"></i> &nbsp;Tambah Desain Neraca
                        </button>
                    </div>
                </div>
  ...
  <div class="modal-dialog" style="width: 70%">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title">Tampilan Neraca</h4>
...
<div id="modal_edit_akun" class="modal">
  <div class="modal-dialog" style="width: 70%">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
        <h4 class="modal-title">Form Edit Data Desain Neraca</h4>
        <input type="hidden" class="parrent"/>
      </div>
      <div class="modal-body" style="padding: 0px;padding-left: 15px;">
...
<div id="modal_tambah_akun" class="modal">
  <div class="modal-dialog" style="width: 70%">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
        <h4 class="modal-title">Form Tambah Data Desain Neraca</h4>
        <input type="hidden" class="parrent"/>
      </div>
      <div class="modal-body" style="padding: 0px;padding-left: 15px;">
        <center class="text-muted" style="padding: 10px;">Menyiapkan Form</center>
  ...
  <div id="modal_detail" class="modal">
    <div class="modal-dialog" style="width: 50%;">
      <div class="modal-content">
        <div class="modal-header">
          <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
          <h4 class="modal-title">Tambahkan Detail Akun di Desain Neraca <span id="title-for"></span></h4>
          <input type="hidden" class="parrent"/>
        </div>
...
<script type="text/javascript">
  ...
  $(document).ready(function(){
    ...
    $("#modal_tambah_akun").on("shown.bs.modal", function(e){
      ...
      $.ajax(baseUrl+"/master_keuangan/desain_neraca/add", {
         timeout: 10000,
         dataType: "html",
    ...
    $(".editDesain").on("click", function(evt){
      ...
      $.ajax(baseUrl+"/master_keuangan/desain_neraca/edit/"+$(this).data("id"), {
         timeout: 10000,
         dataType: "html",
         success: function (data) {
    ...
    $(".hapus").on("click", function(evt){
      ...
      if($trk){
        $.ajax(baseUrl+"/master_keuangan/desain_neraca/delete/"+$(this).data("id"),{
          type: "get",
          dataType: "json",
          success: function(response){
            if(response.status == "sukses"){
