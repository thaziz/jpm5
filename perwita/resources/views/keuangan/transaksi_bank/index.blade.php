        ...
        <div class="col-lg-12" >
            <div class="ibox float-e-margins">
                <div class="ibox-title">
                    <h5> Data Transaksi Bank {{ $cabang_nama }} {{-- Periode {{ date_ind($_GET["date"]) }} {{ $_GET["year"] }} --}}
                    ...
                    <div class="ibox-tools">
                        ...
                        <button class="btn btn-sm btn-primary tambahAkun" data-parrent="0" data-toggle="modal" data-target="#modal_tambah_akun">
                          <i class="fa fa-plus"></i> &nbsp;Tambah Data Transaksi Bank
                        </button>
                    </div>
                </div>
  ...
  <div class="modal-dialog" style="width: 50%; min-height: 650px; margin-top: 30px;">
    <div class="modal-content" style="background: #efefef;">
      <div class="modal-header" style="background: white">
        ...
        <h4 class="modal-title">List Transaksi Bank <span id="cab_list_name"></span></h4>
...
<script type="text/javascript">
  ...
  $(document).ready(function(){
    ...
    $("#modal_tambah_akun").on("shown.bs.modal", function(e){
      ...
      $.ajax(baseUrl+"/keuangan/transaksi_bank/add?cab={{ $_GET['cab'] }}", {
         timeout: 15000,
         dataType: "html",
