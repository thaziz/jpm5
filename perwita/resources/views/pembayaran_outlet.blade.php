  ...
  <div class="position-fixed">
   ...
   <div style="margin-top:20px;">
    <table class="inlineTable pull-right margin-top-60px size" >
     ...
     <tr>
        <td class="top bot right left textcenter paddingkota">Tanggal</td>
        <td class="top bot  left textcenter paddingkota">&nbsp;</td>
     </tr>
     <tr>
        <td class="top bot right left textcenter paddingkota">Kode.Cust.</td>
       <td class="top bot  left textcenter paddingkota">&nbsp;</td>
     </tr>
   </table>
   <table class="inlineTable" style="margin-left: 50%;margin-top: -10%;">
     ...
     <tr>
       <td class="bold textcenter">SBY - MLG</td>
     </tr>
</table>
   ...
   <table class="size textleft"  width="100%">
     <tr>
       <th class="textcenter bot right top">No.</th>
     ...
     <tr>
       <td class="right textcenter">1</td>
       <td class="right textcenter">92919</td>
       <td class="right">12/12/1222 </td>
       <td class="right">PT. ASEP RAKYAT MERDEKA</td>
       <td class="right">PT. ANJAY GUMELAR</td>
       <td class="right">JL SULTAN HORANG KAYA 90 / 0000000</td>
       <td class="right">&nbsp;</td>
       <td class="right">Kilo</td>
       <td class="right textcenter">1</td>
     </tr>
     <tr>
       <td class="right textcenter">1</td>
     ...
     <tr>
       <td class="right textright top bot" colspan="8">Total :</td>
       <td class="textcenter top bot">1</td>
     </tr>
   </table>
   </div>
 </div>
