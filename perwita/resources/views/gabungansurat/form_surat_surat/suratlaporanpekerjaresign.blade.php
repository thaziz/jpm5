        ...
        <div class="col-lg-12" >
            <div class="ibox float-e-margins">
                <div class="ibox-title">
                    <h5> Form Data Pegawai Surat Laporan Pekerja Resign
                ...
                <div class="box-body">
                  <form class="form-horizontal">
                    <div class="form-group">
                      <label class="control-label col-sm-2" for="nik">Nama Pegawai </label>
                        <div class="col-sm-8">
                    ...
                    <div class="form-group">
                      <label class="control-label col-sm-2" for="no peserta">Tempat, Tanggal Lahir</label>
                        <div class="col-sm-8">
                    ...
                    <div class="form-group"> 
                      <div class="col-sm-offset-2 col-sm-10">
                          <a href="{{url('suratlaporanpekerjaresign')}}" class="btn btn-danger" role="button">Cetak Laporan</a>
